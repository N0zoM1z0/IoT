{
	...
	"Click on the pencil icon to give the device a name to make it easy to identify.": "Click on the \"Pencil\" icon to manage devices access or change device name.",
