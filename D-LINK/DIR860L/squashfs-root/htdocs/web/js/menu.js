...
function initialMenu()
{
	...
	menu 		+= "		</ul>";
	menu 		+= "	</li>";
	menu 		+= "	<li class='parent' id='m_Advanced' onmouseover='this.className=\"parentOn\";menu_Check_Advanced=0;' onmouseout='this.className=\"parent\";menu_Check_Advanced=1;' onclick='javascript:CheckClickStatus(\"m_Advanced\");'><a id='menu_Advanced' href='#'>"+I18N("j", "Advanced")+"</a>";
	menu 		+= "		<ul>";
