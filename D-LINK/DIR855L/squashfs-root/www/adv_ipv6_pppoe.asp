...
<script language="JavaScript">
	...
	function onPageLoad(){ 
		...
		set_checked("<!--# echo ipv6_pppoe_dynamic -->", get_by_name("ipv6_pppoe_dynamic"));
...
function send_request(){
	...
	var pppoe_ip_msg = replace_msg(all_ip_addr_msg,IPV6_TEXT43);
	...
	var idle_time_msg = replace_msg(check_num_msg, IPV6_TEXT73, 0, 9999);
	...
	<table border="1" cellpadding="2" cellspacing="0" width="838" height="100%" align="center" bgcolor="#FFFFFF" bordercolordark="#FFFFFF">
		<tr>
	       ...
	       <form id="form1" name="form1" method="post" action="apply.cgi">			
			...
			<input type="hidden" id="action" name="action" value="adv_ipv6_poe">
		  ...
		  <div id=box_header>
                    ...
                    <input name="button2" id="button2" type="button" class=button_submit value="" onclick="return page_cancel('form1', 'adv_ipv6_pppoe.asp');">
			...
			<option value="ipv6_autodetect"><script>show_words(IPV6_TEXT32b);</script></option>
                        ...
                        <option value="ipv6_pppoe" selected><script>show_words(IPV6_TEXT34);</script></option>
				...
				<div class=box id=wan_ipv6_pppoe_settings>
					...
					<table cellSpacing=1 cellPadding=1 width=525 border=0>
						<tr>
                                                  <td width="185" align=right class="duple"><script>show_words(IPV6_PPPoE_session);</script></td>
                                                  <td width="331">&nbsp;
						...
						<tr>
						  ...
						  <td>&nbsp;
							<input type=text id="ipv6_pppoe_ipaddr" name="ipv6_pppoe_ipaddr" size="40" maxlength="39" value="<!--# echo ipv6_pppoe_ipaddr -->">
						  </td>
						</tr>
						<tr>
						...
						<tr>
						  ...
						  <td>&nbsp;
							  <input type=radio name="ipv6_pppoe_connect_mode" value="always_on" onClick="check_ipv6_pppoe_connectmode()" checked>
								<script>show_words(bwn_RM_0);</script>
							  <input type=radio name="ipv6_pppoe_connect_mode" value="on_demand" onClick="check_ipv6_pppoe_connectmode()">
								<script>show_words(bwn_RM_1);</script>
							  <input type=radio name="ipv6_pppoe_connect_mode" value="manual" onClick="check_ipv6_pppoe_connectmode()">
						...
						<tr>
						  ...
						  <td>&nbsp;
							<input type=text id="ipv6_pppoe_idle_time" name="ipv6_pppoe_idle_time" size="10" maxlength="5" value="<!--# echo ipv6_pppoe_idle_time -->">
						...
						<tr>
						  ...
						  <td>&nbsp;
							...
							<script>show_words(bwn_MTU_def);</script> = 1492 </td>
						  </td>
						</tr>
					</table>
			</div>
	         <div class=box id=wan_ipv6_settings>
					...
					<!-- p class="box_msg"><script>show_words(PV6_TEXT64);</script> </p-->
	                ...
	                <table cellSpacing=1 cellPadding=1 width=525 border=0>
	                    ...
	                    <tr>
	                      ...
	                      <td width="331">&nbsp;<input type=text id="ipv6_pppoe_primary_dns" name="ipv6_pppoe_primary_dns" size="30" maxlength="39" value="<!--# echo ipv6_pppoe_primary_dns -->"></td>
	                    </tr>
	                    <tr>
	                      <td width="187" align=right class="duple"><script>show_words(_dns2);</script> :</td>
	                      <td width="331">&nbsp;<input type=text id="ipv6_pppoe_secondary_dns" name="ipv6_pppoe_secondary_dns" size="30" maxlength="39" value="<!--# echo ipv6_pppoe_secondary_dns -->"></td>
	                    </tr>
	                </table>
                 </div> 
		 <div class=box id=lan_ipv6_settings>
			    ...
			    <tr id="tr_dhcp_pd_hint_vltime" style="display:none ">
	                    ...
	                    <tr>
	                      ...
	                      <td width="331">&nbsp;
	                      	<input type=text id="ipv6_pppoe_lan_ip" name="ipv6_pppoe_lan_ip" size="30" maxlength="63" value="<!--# echo ipv6_pppoe_lan_ip -->" onChange="set_ipv6_autoconf_range()">
	                      	<b>/64</b>
	                      </td>
			    </tr> 
			    <tr> 
		 ...
		 <div class="box" id=ipv6_autoconfiguration_settings> 
			  <h2><script>show_words(IPV6_TEXT48);</script></h2>
			   <p class="box_msg"><script>show_words(IPV6_TEXT49);show_words(IPV6_TEXT49a);</script></p>
