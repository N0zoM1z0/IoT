	...
	function send_request(){
		...
		for (var i = 0; i < rule_max_num; i++){		
			...
			if (get_by_id("name" + i).value != ""){
				...
				if(!check_domain(temp_ip_obj, temp_mask_obj, temp_lan_ip_obj) && get_by_id("enable" + i).checked == true) {
                      ...
                      <tbody>
                        ...
                        <script>
							...
							for(var i=0 ; i<rule_max_num ; i++){
								...
								document.write("<td valign=bottom>"+_name+"<br><input type=text class=flatL id=\"name" + i + "\" name=\"name" + i +"\" size=16 maxlength=31></td>");
								...
								document.write("<td align=center valign=bottom>"+av_PubP+"<br><input type=text class=flatL id=public_portS" + i + " name=public_portS" + i +" size=5 maxlength=5></td>");
								...
								document.write("<tr>");
								document.write("<td valign=bottom>"+_ipaddr+"<br><input type=text class=flatL  id=ip" + i + " name=ip" + i +" size=16 maxlength=15></td>");
								document.write("<td align=left valign=bottom>");
								...
								document.write("</select></td>");
								document.write("<td align=center valign=bottom>"+av_PriP+"<br><input type=text class=flatL id=private_portS" + i + " name=private_portS" + i +" size=5 maxlength=5></td>");
