...
*/	
	...
	function send_l2tp_request(){
		...
		if ("<!--# echo wan_proto -->" == "l2tp" && "<!--# echo wan_l2tp_russia_enable -->" == "0")
	...
	<table border="1" cellpadding="2" cellspacing="0" width="838" height="100%" align="center" bgcolor="#FFFFFF" bordercolordark="#FFFFFF">
		<tr>
			...
			<form id="form1" name="form1" method="post" action="apply.cgi">
				...
				<input type="hidden" id="html_response_return_page" name="html_response_return_page" value="wan_rus_l2tp.asp">
				<input type="hidden" id="action" name="action" value="wan_rus_l2tp">
                ...
                <table cellSpacing=1 cellPadding=1 width=525 border=0>
                    <tr>
                      ...
                      <td width="331">&nbsp; <select name="wan_proto" id="wan_proto" onChange="change_wan()">
						...
						<option value="l2tp" selected><script>show_words(bwn_Mode_RUS_L2TP)</script></option>
                        <!--option value="bigpond"><script>show_words(bwn_Mode_BigPond)</script></option-->
                      </select></td>
                    </tr>
                </table>
              </div>    
              <div class=box id=show_rus_l2tp>
                <h2><script>show_words(bwn_RUSL2TPICT);</script></h2>
