...
// ipv6 
	...
	if (ddns_type =="www.dlinkddns.com" & ddns_dyndns_kinds =="Dynamic"){
		get_by_id("ddns_type_value").value = "www.dlinkddns.com(Free)";
	}else if (ddns_type =="www.DynDns.com" & ddns_dyndns_kinds =="Custom"){
		get_by_id("ddns_type_value").value = "www.DynDns.com(Custom)";
	}else if (ddns_type =="www.DynDns.com" & ddns_dyndns_kinds =="Dynamic"){
		get_by_id("ddns_type_value").value = "www.DynDns.com(Free)";
	}else{
		get_by_id("ddns_type_value").value = ddns_type;
	}
			...
			<td valign="top" id="maincontent_container">
				<div id="maincontent">
				  ...
				  <div id="box_header"> 
						...
						<p><script>show_words(td_intro_DDNS_DLINK)</script> <a href="http://www.dlinkddns.com" onclick="return jump_if();" target="_blank">www.DLinkDDNS.com.</a></p>
						<br>
                                ...
                                <tr>
                                  ...
                                  <td height=20>&nbsp;&nbsp;
                                    ...
                                    <select id="ddns_type_sel" name="ddns_type_sel" tabindex=2>
									  ...
									  <option value="dlinkddns.com">www.dlinkddns.com(Free)</option>
									  <option value="dyndns.com">www.DynDns.com(Custom)</option>
