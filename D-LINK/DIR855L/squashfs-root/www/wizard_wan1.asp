			...
			<input type="hidden" id="asp_temp_00" name="asp_temp_00">
                <table class=formarea>
                    <tr>
                      ...
                      <td>&nbsp;
                        <input type="password" id=pwd1 name=pwd1 size=20 maxlength=15 value="<!--# echo asp_temp_00 -->">
                      </td>
                    </tr>
                    <tr>
                      <td align=right class="duple"><script>show_words(_verifypw);</script>&nbsp;:</td>
                      <td>&nbsp;
                        <input type="password" id=pwd2 name=pwd2 size=20 maxlength=15 value="<!--# echo asp_temp_00 -->">
                      </td>
                    </tr>
                </table>
                <br>
