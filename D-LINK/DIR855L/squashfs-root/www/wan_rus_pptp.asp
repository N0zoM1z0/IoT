...
/*	function show_AdvDns() {
	...
	function send_pptp_request(){
		...
		if ("<!--# echo wan_proto -->" == "pptp" && "<!--# echo wan_pptp_russia_enable -->" == "0")
	...
	<table border="1" cellpadding="2" cellspacing="0" width="838" height="100%" align="center" bgcolor="#FFFFFF" bordercolordark="#FFFFFF">
		<tr>
			...
			<form id="form1" name="form1" method="post" action="apply.cgi">
				...
				<input type="hidden" id="action" name="action" value="wan_rus_pptp">
			...
			<!-- <option value="dslite">DS-Lite</option> -->
						...
						<option value="pptp" selected><script>show_words(bwn_Mode_RUS_PPTP)</script></option>
						<script>
							if ("<!--# echo feature_russsia -->" == "1") {
              ...
              <div class=box id=show_rus_pptp>
                <h2><script>show_words(bwn_RUSPPTPICT);</script></h2>
