                  ...
                  <tbody>
					<tr>
						<td id="sidenav_container">
							...
							<!-- === BEGIN SIDENAV === -->
								<ul>
									<li><div><a href="tools_admin.asp" onclick="return jump_if();"><script>show_words(Device_Admin);</script></a></div></li>
									<li><div><a href="tools_system.asp" onclick="return jump_if();"><script>show_words(_saveandrestore);</script></a></div></li>
									<li><div><a href="tools_firmw.asp" onclick="return jump_if();"><script>show_words(_firmwareupdate);</script></a></div></li>
									<li><div><a href="tools_ddns.asp" onclick="return jump_if();"><script>show_words(_ddnssetting);</script></a></div></li>
								  	<li><div><a href="tools_vct.asp" onclick="return jump_if();"><script>show_words(_scheds);</script></a></div></li>
									<li><div><a href="tools_schedules.asp" onclick="return jump_if();"><script>show_words(_scheds);</script></a></div></li>
									<li><div id="sidenavoff"><script>show_words(_longsetting);</script></div></li>
			...
			<td valign="top" id="maincontent_container">			  
				<div id="maincontent">
				  ...
				  <div id="box_header"> 
						...
						<p><script>show_words(tsl_intro);</script></p>
						<p>
						  <input name="button3" id="button3" type="button" class=button_submit value="" onClick="send_request()">
                          <input name="button2" id="button2" type="reset" class=button_submit value="" onclick="return page_cancel('form1', 'st_log_settings.asp');">
				...
				<p>
				  <input name="button33" id="button33" type="button" class=button_submit value="" onClick="send_request()">
                  <input name="button44" id="button44" type=reset class=button_submit value=""  onClick="window.location.href='st_log_settings.asp'">
					<script>get_by_id("button33").value = _savesettings;</script>
					<script>get_by_id("button44").value = _dontsavesettings;</script>
				</p>
				</div>
			</td>
			</form>
