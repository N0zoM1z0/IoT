      ...
      <td>
	   ...
	   <!-- wz_page_1 -->
            <div id="wz_page_1" style="display:none">
                <input type="hidden" id="html_response_page" name="html_response_page" value="wizard_reboot.asp">
            ...
            <div id="wz_page_2" style="display:none">
                ...
                <table class=formarea>
                    <tr>
                      ...
                      <td>&nbsp;<input type="password" id="admin_password" name="admin_password" size=20 maxlength=15 value="<!--# echo admin_password -->"></td>
                    </tr>
                    <tr>
                      <td align=right class="duple"><script>show_words(_verifypw);</script> :</td>
                      <td>&nbsp;<input type="password" id="admin_password2" name="admin_password2" size=20 maxlength=15 value="<!--# echo admin_password -->"></td>
                    </tr>
                </table>
                <br>
            </div><!-- wz_page_2 -->
