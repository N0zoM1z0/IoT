...
<script>show_top("setup");</script>
	...
	<table border="1" cellpadding="2" cellspacing="0" width="838" height="100%" align="center" bgcolor="#FFFFFF" bordercolordark="#FFFFFF">
		...
		<input type="hidden" id="action" name="action" value="adv_ipv6_static">
		...
		<input type="hidden" id="page_type" name="page_type" value="IPv6">
		  ...
		  <div id=box_header>
                    ...
                    <input name="button2" id="button2" type="button" class=button_submit value="" onclick="return page_cancel('form1', 'adv_ipv6_static.asp');">
		 ...
		 <div class=box id=lan_ipv6_settings>
	                ...
	                <table cellSpacing=1 cellPadding=1 width=525 border=0>
	                    <tr>
	                      ...
	                      <td width="331">&nbsp;
	                      	<input type=text id="ipv6_static_lan_ip" name="ipv6_static_lan_ip" size="30" maxlength="63" value="<!--# echo ipv6_static_lan_ip -->" onChange="set_ipv6_autoconf_range()">
	                      	<b>/64</b>
	                      </td>
			    </tr>
			    <tr>
