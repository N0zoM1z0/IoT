...
var month_device = new Array(get_words('tt_Jan'), get_words('tt_Feb'), get_words('tt_Mar'), get_words('tt_Apr'), get_words('tt_May'), get_words('tt_Jun'), get_words('tt_Jul'),
						get_words('tt_Aug'),get_words('tt_Sep'), get_words('tt_Oct'), get_words('tt_Nov'), get_words('tt_Dec'));
...
var all_ip_addr_msg = new Array(which_lang[MSG006],	// INVALID_IP
						       which_lang[MSG007],	// ZERO_IP
						       which_lang[MSG002],	// FIRST_IP_ERROR
						       which_lang[MSG003],	// SECOND_IP_ERROR
						       which_lang[MSG004],	// THIRD_IP_ERROR
						       which_lang[MSG005],	// FOURTH_IP_ERROR
						       which_lang[MSG026],			// FIRST_RANGE_ERROR
						       which_lang[MSG027],			// SECOND_RANGE_ERROR
						       which_lang[MSG028],			// THIRD_RANGE_ERROR
						       which_lang[MSG029],		// FOURTH_RANGE_ERROR
						       which_lang[MSG008],		// RADIUS_SERVER_PORT_ERROR
						       which_lang[MSG009],		// RADIUS_SERVER_SECRET_ERROR
						       which_lang[MSG010]			// MULTICASE_IP_ERROR
						      );

var subnet_mask_msg = new Array(which_lang[ar_alert_5],	// INVALID_IP
					           which_lang[ar_alert_5],	// ZERO_IP
					           which_lang[ar_alert_5],	// FIRST_IP_ERROR
					    	   which_lang[ar_alert_5],	// SECOND_IP_ERROR
					    	   which_lang[ar_alert_5],	// THIRD_IP_ERROR
					    	   which_lang[ar_alert_5],	// FOURTH_IP_ERROR
					    	   which_lang[ar_alert_5],			// FIRST_RANGE_ERROR
					    	   which_lang[ar_alert_5],			// SECOND_RANGE_ERROR
					    	   which_lang[ar_alert_5],			// THIRD_RANGE_ERROR
					    	   which_lang[ar_alert_5]			// FOURTH_RANGE_ERROR
					          );
var metric_msg = new Array(which_lang[MSG043],
						 which_lang[MSG043],
						 which_lang[ar_alert_3]
						 );	
...
var check_num_msg = new Array(which_lang[MSG012],
						 which_lang[MSG013],
						 which_lang[MSG014],
						 which_lang[MSG015]
						 );
...
var key_len_error = new Array(which_lang[MSG016],
							  which_lang[MSG017]
							   );

var illegal_key_error = new Array(which_lang[TEXT042_1]+which_lang[TEXT042_2],
								  which_lang[TEXT042_1]+which_lang[TEXT042_2],
								  which_lang[TEXT042_1]+which_lang[TEXT042_2],
								  which_lang[TEXT042_1]+which_lang[TEXT042_2]								 
								  );
...
var all_ipv6_addr_msg = new Array(which_lang[MSG006],	// INVALID_IP
						       which_lang[MSG007],	// ZERO_IP such as '::' symbol
						       which_lang[MSG018],	// FIRST_IP_ERROR
						       which_lang[MSG019],	// SECOND_IP_ERROR
						       which_lang[MSG020],	// THIRD_IP_ERROR
						       which_lang[MSG021],	// FOURTH_IP_ERROR
						       which_lang[MSG022],	// FIFTH_IP_ERROR
						       which_lang[MSG023],	// SIXTH_IP_ERROR
						       which_lang[MSG024],	// SEVENTH_IP_ERROR
						       which_lang[MSG025],	// EIGHTH_IP_ERROR
						       which_lang[MSG026],		// FIRST_RANGE_ERROR
						       which_lang[MSG027],		// SECOND_RANGE_ERROR
						       which_lang[MSG028],		// THIRD_RANGE_ERROR
						       which_lang[MSG029],		// FOURTH_RANGE_ERROR
						       which_lang[MSG030],		// FIFTH_RANGE_ERROR
						       which_lang[MSG031],		// SIXTH_RANGE_ERROR
						       which_lang[MSG032],		// SEVENTH_RANGE_ERROR
						       which_lang[MSG033],		// EIGHTH_RANGE_ERROR
						       "", 						// RADIUS_SERVER_PORT_ERROR
						       "",						// RADIUS_SERVER_SECRET_ERROR
  						       which_lang[MSG034],  // LOOPBACK_IP_ERROR
  						       which_lang[MSG035]  // MULTICASE_IP_ERROR	
						      );
