		...
		<form id="form1" name="form1" method="post" action="apply.cgi">
			...
			<td valign="top" id="maincontent_container">
				<div id="maincontent">
					<div id="box_header">
						<h1>
							<script>show_words(DNS_TEXT0)</script>
						</h1>
						<script>show_words(DNS_TEXT1)</script>
						<br>
						<br>
					...
					<div class="box">
						<h2>
							<script>show_words(DNS_TEXT2)</script>
						</h2>

						<table cellpadding="1" cellspacing="1" border="0" width="525">
							<tr>
								<td width="30">
									<input type="radio" align="left" id="opendns_mode" name="opendns_mode" value="1" onclick="opendns_mode_selector(this.value);" default="false">
								</td>
								<td width="480"><b><script>show_words(DNS_TEXT3)</script></b></td>
								<td></td>
							</tr>
							<tr>
								<td></td>
								<td><script>show_words(DNS_TEXT4)</script></td>
							</tr>

							<tr>
								<td width="30">
									<input type="radio" align="left" id="opendns_mode" name="opendns_mode" value="2" onclick="opendns_mode_selector(this.value);" default="false">
								</td>
								<td width="480"><b><script>show_words(DNS_TEXT5)</script></b></td>
								<td></td>
							</tr>
							<tr>
								<td></td>
								<td><script>show_words(DNS_TEXT6)</script></td>
							</tr>

							<tr>
								<td width="30">
									<input type="radio" align="left" id="opendns_mode" name="opendns_mode" value="3" onclick="opendns_mode_selector(this.value);" default="false">
								</td>
								<td width="480"><b><script>show_words(DNS_TEXT7)</script></b></td>
								<td></td>
							</tr>
							<tr>
								<td></td>
								<td>
									<script>show_words(DNS_TEXT8)</script>
									<br><br>
									<a id="opendns_dashboard2" target="_blank" href="https://www.opendns.com/device/settings?deviceid=0002DB434F264503">Manage your router</a> at <a target="_blank" href="http://www.opendns.com/">www.opendns.com</a>
									<br><br>
								</td>
							</tr>
							...
							<tr>
								<td width="30">
									<input type="radio" align="left" id="opendns_mode" name="opendns_mode" value="0" onclick="opendns_mode_selector(this.value);" default="false">
								</td>
								<td width="480"><b><script>show_words(DNS_TEXT9)</script></b></td>
								<td></td>
							</tr>
							<tr>
								<td></td>
								<td><script>show_words(DNS_TEXT10)</script></td>
							</tr>
			...
			<table cellSpacing=0 cellPadding=2 bgColor=#ffffff border=0>
				<tr>
					<td id=help_text>
						...
						&hellip;</strong> 
						<p>
							<script>show_words(DNS_TEXT11)</script>
						</p>

						<p>
							<script>show_words(DNS_TEXT12)</script>
						</p>
						<!--
						<p>
