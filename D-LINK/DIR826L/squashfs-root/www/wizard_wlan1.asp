...
<td bgcolor="#FFFFFF">
  <table id="header_container" border="0" cellpadding="5" cellspacing="0" width="838" align="center">
    <tr>
      <td width="100%">&nbsp;&nbsp;<script>show_words(TA2)</script>: <a href="http://www.dlink.com/default.aspx"><% CmoGetCfg("model_number","none"); %></a></td>
            ...
            <table align="center" class="formarea" summary="wizard wep">
			  ...
			  <tr>
                ...
                <script>get_by_id("cancel_b").value = _cancel;</script>
				  ...
				  <input type="hidden" id="html_response_lang" name="html_response_lang" value="wizard_wlan1.asp">

				  <input type="hidden" id="language" name="language" value= "<% CmoGetCfg("language","none"); %>">

				  <select name="site" id="site" style="vertical-align:top; height:20px; font-size:8pt;" onChange="set_lang();">



				<option value="de">

				    <script>show_words(DE)</script>

				    </option>

				    <option value="en">

				    <script>show_words(EN)</script>

				    </option>

				    <option value="es">

				    <script>show_words(ES)</script>

				    </option>

				    <option value="fr">

				    <script>show_words(FR)</script>

				    </option>

				    <option value="it">

				    <script>show_words(IT)</script>
