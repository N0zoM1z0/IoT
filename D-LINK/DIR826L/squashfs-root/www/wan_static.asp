...
<script language="JavaScript">
	...
	param.arg = "ccp_act=get&num_inst=9";
	param.arg +="&oid_1=IGD_&inst_1=10000";
	param.arg +="&oid_2=IGD_WANDevice_i_WANConnectionDevice_i_&inst_2=11100";
	param.arg +="&oid_3=IGD_WANDevice_i_WANConnectionDevice_i_StaticIP_i_&inst_3=11110";
	param.arg +="&oid_4=IGD_LANDevice_i_LANHostConfigManagement_&inst_4=11100";
	param.arg +="&oid_5=IGD_LANDevice_i_LANHostConfigManagement_&inst_5=11100";
	param.arg +="&oid_6=IGD_WANDevice_i_TrafficControl_&inst_6=11100";
	param.arg +="&oid_7=IGD_Firewall_&inst_7=11000";
	param.arg +="&oid_8=IGD_WANDevice_i_WANIPv6ConnectionDevice_i_&inst_8=11100";
	param.arg +="&oid_9=IGD_WANDevice_i_WANIPv6ConnectionDevice_i_PPPoE_i_&inst_9=11110";	
	...
	var adv_dns_en = config_val('staticIPCfg_AdvancedDNSEnable_');
	...
	var staticIPDNS = config_val("staticIPCfg_DNSServers_").split(",");
...
function onPageLoad(){
	...
	get_by_id("wan_static_ipaddr").value = config_val("staticIPCfg_ExternalIPAddress_");
	get_by_id("wan_static_netmask").value = config_val("staticIPCfg_SubnetMask_");
	get_by_id("wan_static_gateway").value = config_val("staticIPCfg_DefaultGateway_");
	...
	get_by_id("wan_primary_dns").value = staticIPDNS[0];
	if(staticIPDNS[1])
		get_by_id("wan_secondary_dns").value = staticIPDNS[1];
	else
		get_by_id("wan_secondary_dns").value = "0.0.0.0";

	get_by_id("wan_mtu").value = config_val("staticIPCfg_MaxMTUSize_");
...
function send_static_request(){
		...
		if(config_val("lanHostCfg_IPAddress_"))
			lanip = config_val("lanHostCfg_IPAddress_");
		else
			lanip = "0.0.0.0";
		
		if(config_val("lanHostCfg_SubnetMask_"))
			lanmask = config_val("lanHostCfg_SubnetMask_");
		else
	...
	{
		get_by_id("staticIPCfg_ExternalIPAddress_1.1.1.1.0").value = get_by_id("wan_static_ipaddr").value;
		get_by_id("staticIPCfg_SubnetMask_1.1.1.1.0").value = get_by_id("wan_static_netmask").value;
		get_by_id("staticIPCfg_DefaultGateway_1.1.1.1.0").value = get_by_id("wan_static_gateway").value;
		//get_by_id("staticIPCfg_DNSEnabled_1.1.1.1.0").value = get_by_id("").value;
		get_by_id("staticIPCfg_DNSServers_1.1.1.1.0").value = get_by_id("wan_primary_dns").value;
		if(get_by_id("wan_secondary_dns").value != "")
			get_by_id("staticIPCfg_DNSServers_1.1.1.1.0").value += ","+get_by_id("wan_secondary_dns").value;

		get_by_id("staticIPCfg_MaxMTUSize_1.1.1.1.0").value = get_by_id("wan_mtu").value;
		...
		get_by_id("staticIPCfg_AdvancedDNSEnable_1.1.1.1.0").value = get_checked_value(get_by_id("opendns_enable_sel"));
...
<body topmargin="1" leftmargin="0" rightmargin="0" bgcolor="#757575">
    ...
    <table id="topnav_container" border="1" cellpadding="2" cellspacing="0" width="838" height="100%" align="center" bgcolor="#FFFFFF" bordercolordark="#FFFFFF">        <tr>
			...
			<form id="form2" name="form2" method="post" action="get_set.ccp">
				...
				<input type="hidden" name="wanConnDev_CurrentConnObjType_1.1.1.0.0" id="wanConnDev_CurrentConnObjType_1.1.1.0.0" value="0">
				...
				<input type="hidden" name="staticIPCfg_Name_1.1.1.1.0" id="staticIPCfg_Name_1.1.1.1.0" value="">
				<input type="hidden" name="staticIPCfg_AdvancedDNSEnable_1.1.1.1.0" id="staticIPCfg_AdvancedDNSEnable_1.1.1.1.0" value="0">
				<input type="hidden" name="staticIPCfg_ExternalIPAddress_1.1.1.1.0" id="staticIPCfg_ExternalIPAddress_1.1.1.1.0" value="">
				<input type="hidden" name="staticIPCfg_SubnetMask_1.1.1.1.0" id="staticIPCfg_SubnetMask_1.1.1.1.0" value="1">
				<input type="hidden" name="staticIPCfg_DefaultGateway_1.1.1.1.0" id="staticIPCfg_DefaultGateway_1.1.1.1.0" value="">
				<input type="hidden" name="staticIPCfg_DNSEnabled_1.1.1.1.0" id="staticIPCfg_DNSEnabled_1.1.1.1.0" value="">
				<input type="hidden" name="staticIPCfg_DNSServers_1.1.1.1.0" id="staticIPCfg_DNSServers_1.1.1.1.0" value="">
				<input type="hidden" name="staticIPCfg_MaxMTUSize_1.1.1.1.0" id="staticIPCfg_MaxMTUSize_1.1.1.1.0" value="">
                ...
                <table cellSpacing=1 cellPadding=1 width=525 border=0>
                    <tr>
                      ...
                      <td width="331">&nbsp; <select name="wan_proto" id="wan_proto" onChange="change_wan()">
                    	...
                    	<option value="0" selected><script>show_words(_sdi_staticip)</script></option>
