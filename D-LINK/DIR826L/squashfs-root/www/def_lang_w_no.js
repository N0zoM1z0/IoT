...
var which_lang = new Array ( //_NO_SHARE_NAME_
	...
	"Ruter kan ikke oppdage din Internett-tilkoblingstype.", //ES_auto_detect_failed_desc
	"Vil du bokmerke \"D-Link Ruter-webadministrasjon\"?", //ES_bookmark
	"Prøv igjen", //ES_btn_try_again
	"Sett den ene enden av Ethernet-kabelen som fulgte med ruteren i porten merket INTERNET på baksiden av ruteren.  Koble den andre enden av kabelen til Ethernet-porten på modemet. ", //ES_cable_lost_desc
	...
	"(GMT-06:00) Sentralamerika, Saskatchewan", //up_tz_07
	"(GMT-07:00) Central Time (US og Canada)", //up_tz_08
	...
	"(GMT+01:00) Amsterdam, Berlin, Bern, Roma, Stockholm", //up_tz_26
	...
	"(GMT+08:00) Beijing, Chongqing, Hong Kong, Taipei", //up_tz_55
	...
	"(GMT+11:00) Solomon-øyene, New Caledonia", //up_tz_70
	...
	"Velg riktig tidssone for stedet du befinner deg på. Denne informasjonen er nødvendig for å konfigurere tidsbaserte alternativer for ruteren.", //wwa_intro_s2
	...
	"Velg dette alternativet hvis din Internett-forbindelse krever brukernavn og passord for å komme på nettet. De fleste DSL-modemer bruker denne tilkoblingstypen.", //wwa_msg_pppoe
