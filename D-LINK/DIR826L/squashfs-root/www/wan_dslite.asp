...
var dev_info = get_router_info();
	...
	function copyDataToDataModelFormat()
	{
		...
		if(get_by_id("b4_ipv4_addr_suffix").value=="")
			get_by_id("dsLiteConn_B4IPv4Address_1.1.1.1.0").value = "192.168.0.0";
		else	
			get_by_id("dsLiteConn_B4IPv4Address_1.1.1.1.0").value = "192.168.0." + get_by_id("b4_ipv4_addr_suffix").value;
	}
		...
		<tr>
          ...
          <div id=box_header>
                    ...
                    <br>
                        ...
                        <input name="button2" id="button2" type="button" class=button_submit value="" onclick="page_cancel('form1', 'ipv6_dslite.asp');">                      
             ...
             <div class=box>
                    ...
                    <table cellSpacing=1 cellPadding=1 width=525 border=0>
						...
						<tr>
                          ...
                          <td width="331">&nbsp;192.168.0.<input type=text id="b4_ipv4_addr_suffix" name="b4_ipv4_addr_suffix" size="5" maxlength="39" value=''>
