...
<script language="JavaScript">
	...
	function constructParamPPPoE()
	{
		...
		paramStr += "&ipv6PPPoEConn_ServiceName_1.1.1.1.0=" + $('#ipv6_pppoe_service').val();
		paramStr += "&ipv6PPPoEConn_AutomaticDNSServer_1.1.1.1.0=0";
		paramStr += "&lanIPv6Cfg_DHCPPDEnable_1.1.1.0.0=1";
		paramStr += "&lanIPv6Cfg_AutoDHCPPDEnable_1.1.1.0.0=1";
		paramStr += "&lanIPv6Cfg_AutoV6AddressAssignEnable_1.1.1.0.0=1";
			...
			<div class=box id="p2c"> 
				...
				<div align="left"> 
					...
					<tr>
						...
						<td width="331">&nbsp;<b><input type=text id="ipv6_6rd_prefix" name="ipv6_6rd_prefix" size="22" maxlength="21" value="" onChange="ipv6_6rd_prefix_onchange()">
							/<input type=text id="ipv6_6rd_prefix_length" name="ipv6_6rd_prefix_length" size="5" maxlength="2" value="32" onChange="ipv6_6rd_prefix_onchange()"></td>
					</tr>
					<tr>
						...
						<td width="331"><b><span id="wan_ip"></span></b>&nbsp;<script>show_words(mask_len)</script>:
							<input type=text id="ipv6_6rd_ipv4_mask_length" name="ipv6_6rd_ipv4_mask_length" size="5" maxlength="2" value="0" onChange="ipv6_6rd_prefix_onchange()">
						</td>
					</tr>
					<tr>
