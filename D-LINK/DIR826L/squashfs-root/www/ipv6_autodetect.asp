...
<script>
	...
	function send_request()
	{
		...
		var v6_primary_dns_msg = replace_msg(all_ipv6_addr_msg,get_words('DNS_ADDRESS_DESC', msg));
		var secondary_dns = $('#ipv6_dhcp_secondary_dns').val();
		var secondary_dns_msg = replace_msg(all_ip_addr_msg,get_words('SEC_DNS_ADDRESS_DESC', msg));
