...
<script>
	...
	param.arg +="&oid_2=IGD_WANDevice_i_WANIPv6ConnectionDevice_i_6in4Tunnel_i_&inst_2=11110";	
	...
	var wan_addr4 = config_val("igdWanStatus_IPAddress_");	//6in4 settings
	var auto_dns_enable = config_val("ipv66in4Conn_AutomaticDNSServer_");;	//IPv6 DNS settings
	...
	function onPageLoad()
	{
		...
		$('#ipv4_6in4_remote_ip').val(config_val("ipv66in4Conn_RemoteV4Address_"));
		$('#ipv6_6in4_remote_ip').val(filter_ipv6_addr(config_val("ipv66in4Conn_RemoteV6Address_")));
		$('#ipv4_6in4_wan_ip').html(wan_addr4);
		$('#ipv6_6in4_wan_ip').val(filter_ipv6_addr(config_val("ipv66in4Conn_LocalV6Address_")));

		//IPv6 DNS settings
		set_checked(0, get_by_name("ipv6_dns_6in4_enable"));
		set_checked(auto_dns_enable, get_by_name("ipv6_dns_6in4_enable"));
		$('#ipv6_6in4_primary_dns').val(filter_ipv6_addr(config_val("ipv66in4Conn_PrimaryDNSAddress_")));
		$('#ipv6_6in4_secondary_dns').val(filter_ipv6_addr(config_val("ipv66in4Conn_SecondaryDNSAddress_")));
		disable_ipv6_6in4_auto_dns();

		//LAN IPv6 address settings
		$('#ipv6_6in4_lan_ip').val(filter_ipv6_addr(config_val("lanIPv6Cfg_Tunnel6in4LanAddress_")));
		...
		$('#ipv6_6in4_adver_lifetime').val(config_val("lanIPv6Cfg_AdvertisementLifetime_"));
		$('#ipv6_dhcpd_lifetime').val(config_val("lanIPv6Cfg_IPv6AddressLifeTime_"));
		//$('#wan_ipv6_settings').hide();
		//$('#lan_ipv6_settings').hide();
	...
	function disable_ipv6_6in4_auto_dns()
	{
		...
		$('#ipv6_6in4_primary_dns').attr('disabled',fixIP[0].checked);
		$('#ipv6_6in4_secondary_dns').attr('disabled',fixIP[0].checked);
		if(fixIP[0].checked)
		{
			$('#ipv6_6in4_primary_dns').val(filter_ipv6_addr(config_val('igdIPv6Status_PrimaryDNSAddress_')));
			$('#ipv6_6in4_secondary_dns').val(filter_ipv6_addr(config_val('igdIPv6Status_SecondaryDNSAddress_')));
		}
		else
		{
			$('#ipv6_6in4_primary_dns').val(filter_ipv6_addr(config_val("ipv66in4Conn_PrimaryDNSAddress_")));
	...
	function disable_ipv6_dhcp_pd_chk(){	//20120207 fix with 835
		...
		disabled_field('ipv6_6in4_lan_ip',pdchk);
		disabled_field('ipv6_dhcpd_lifetime',pdchk);
		disabled_field('ipv6_dhcp_pd_lan',true);
		disabled_field('ipv6_6in4_adver_lifetime',true);
		...
		if (pdchk == true)
		{
			...
			if (selchk == true)
				disabled_field('ipv6_6in4_adver_lifetime',false);
		}

		if($('#ipv6_dhcp_pd_chk')[0].checked)
		{
			$('#ipv6_6in4_lan_ip').val(filter_ipv6_addr(config_val('igdIPv6Status_IPv6LanAddress_')));
			$('#ipv6_6in4_adver_lifetime').val(config_val('igdIPv6Status_IPv6LifeTime_'));
	...
	{
		var ipv6_lan_ip = $('#ipv6_6in4_lan_ip').val();
	...
	{
		var remote_ipv4 = $('#ipv4_6in4_remote_ip').val();
		var remote_ipv4_msg = replace_msg(all_ip_addr_msg,get_words('IPV6_TEXT40'));
		var temp_remote_ipv4 = new addr_obj(remote_ipv4.split("."), remote_ipv4_msg, false, false);
		var remote_ipv6 = $('#ipv6_6in4_remote_ip').val();
		var remote_ipv6_msg = replace_msg(all_ipv6_addr_msg,get_words('IPV6_TEXT41'));
		var temp_remote_ipv6 = new ipv6_addr_obj(remote_ipv6.split(":"), remote_ipv6_msg, false, false);
		var local_ipv6 = $('#ipv6_6in4_wan_ip').val();
		var local_ipv6_msg = replace_msg(all_ipv6_addr_msg,get_words('IPV6_TEXT43'));
		var temp_local_ipv6 = new ipv6_addr_obj(local_ipv6.split(":"), local_ipv6_msg, false, false);
		var primary_dns = $('#ipv6_6in4_primary_dns').val();
		var v6_primary_dns_msg = replace_msg(all_ipv6_addr_msg,get_words('DNS_ADDRESS_DESC')); 
		var secondary_dns = $('#ipv6_6in4_secondary_dns').val();
		var v6_secondary_dns_msg = replace_msg(all_ipv6_addr_msg,get_words('SEC_DNS_ADDRESS_DESC')); 
		var ipv6_lan = $('#ipv6_6in4_lan_ip').val();
		...
		var adver_lifetime_obj = new varible_obj($('#ipv6_6in4_adver_lifetime').val(), adver_lifetime_msg , 1, 999999, false);
		...
		$('#ipv6_6in4_dns_enable').val(get_checked_value(get_by_name("ipv6_dns_6in4_enable")));
		$('#ipv6_wan_specify_dns').val($('#ipv6_6in4_dns_enable').val());
	...
	function submit_6in4()
	{
		...
		param6in4.arg += "&wanIPv6ConnDev_CurrentConnObjType_1.1.1.0.0=4";

		param6in4.arg += "&ipv66in4Conn_RemoteV4Address_1.1.1.1.0="+$('#ipv4_6in4_remote_ip').val();
		param6in4.arg += "&ipv66in4Conn_RemoteV6Address_1.1.1.1.0="+$('#ipv6_6in4_remote_ip').val();
		param6in4.arg += "&ipv66in4Conn_LocalV6Address_1.1.1.1.0="+$('#ipv6_6in4_wan_ip').val();
		param6in4.arg += "&ipv66in4Conn_AutomaticDNSServer_1.1.1.1.0="+get_checked_value(get_by_name("ipv6_dns_6in4_enable"));
		param6in4.arg += "&ipv66in4Conn_PrimaryDNSAddress_1.1.1.1.0="+$('#ipv6_6in4_primary_dns').val();
		param6in4.arg += "&ipv66in4Conn_SecondaryDNSAddress_1.1.1.1.0="+$('#ipv6_6in4_secondary_dns').val();
		param6in4.arg += "&lanIPv6Cfg_Tunnel6in4LanAddress_1.1.1.0.0="+$('#ipv6_6in4_lan_ip').val();

		param6in4.arg += "&lanIPv6Cfg_DHCPPDEnable_1.1.1.1.0="+get_checked_value($('#ipv6_dhcp_pd_chk')[0]);
		param6in4.arg += "&lanIPv6Cfg_AutoDHCPPDEnable_1.1.1.1.0="+get_checked_value($('#ipv6_dhcp_pd_lan')[0]);
		param6in4.arg += "&lanIPv6Cfg_AutoV6AddressAssignEnable_1.1.1.0.0="+get_checked_value($('#ipv6_autoconfig_sel')[0]);
		param6in4.arg += "&lanIPv6Cfg_AutoConfigurationType_1.1.1.0.0="+$('#ipv6_autoconfig_type')[0].selectedIndex;
		param6in4.arg += "&lanIPv6Cfg_AdvertisementLifetime_1.1.1.0.0="+$('#ipv6_6in4_adver_lifetime').val();
		param6in4.arg += "&lanIPv6Cfg_DHCPv6AddressRangeStart_1.1.1.0.0="+$('#ipv6_addr_range_start_prefix').val() + "::" + $('#ipv6_addr_range_start_suffix').val();
		param6in4.arg += "&lanIPv6Cfg_DHCPv6AddressRangeEnd_1.1.1.0.0="+$('#ipv6_addr_range_end_prefix').val() + "::" + $('#ipv6_addr_range_end_suffix').val();
		param6in4.arg += "&lanIPv6Cfg_IPv6AddressLifeTime_1.1.1.0.0="+$('#ipv6_dhcpd_lifetime').val();

		get_config_obj(param6in4);
	}
</script>
</head>
<body onload="onPageLoad();" topmargin="1" leftmargin="0" rightmargin="0" bgcolor="#757575">
	...
	<tr>
		...
		<form id="form1" name="form1" method="post" action="apply.cgi">
			...
			<input type="hidden" id="ipv6_6in4_dns_enable" name="ipv6_6in4_dns_enable" value=''>
			...
			<input type="hidden" id="ipv6_ra_adv_default_lifetime_l" name="ipv6_ra_adv_default_lifetime_l" value=''>
		...
		<div id="maincontent">
			<div id="box_header">
				...
				<input name="button2" id="button2" type="button" class=button_submit value="" onclick="page_cancel('form1', 'ipv6_6in4.asp');">                      
			...
			<div class=box>
				...
				<tr>
					...
					<td width="331">&nbsp; <select name="ipv6_w_proto" id="ipv6_w_proto" onChange='change_ipv6_type()'>
						...
						<option value="4" selected><script>show_words(IPV6_TEXT35)</script></option>
			...
			<div class=box id=wan_ipv6_settings>
				...
				<tr>
					...
					<td width="331">&nbsp;<input type=text id="ipv4_6in4_remote_ip" name="ipv4_6in4_remote_ip" size="16" maxlength="15" value=''></td>
				</tr>
				<tr>
					<td width="187" align=right class="duple"><script>show_words(IPV6_TEXT41)</script> :</td>
					<td width="331">&nbsp;<input type=text id="ipv6_6in4_remote_ip" name="ipv6_6in4_remote_ip" size="30" maxlength="39" value=''></td>
				</tr>
				<tr>
					<td width="187" align=right class="duple"><script>show_words(IPV6_TEXT42)</script> :</td>
					<td width="331">&nbsp;<span id="ipv4_6in4_wan_ip"></span></td>
				</tr>
				<tr>
					<td width="187" align=right class="duple"><script>show_words(IPV6_TEXT43)</script> :</td>
					<td width="331">&nbsp;<input type=text id="ipv6_6in4_wan_ip" name="ipv6_6in4_wan_ip" size="30" maxlength="39" value=''></td>
				</tr>
				</table>
			</div>
			...
			<div class=box id=lan_ipv6_settings>
				...
				<tr>
					...
					<td width="331">&nbsp;<input type=text id="ipv6_6in4_primary_dns" name="ipv6_6in4_primary_dns" size="30" maxlength="39" value=''></td>
				</tr>
				<tr>
					<td width="187" align=right class="duple"><script>show_words(_dns2_v6)</script> :</td>
					<td width="331">&nbsp;<input type=text id="ipv6_6in4_secondary_dns" name="ipv6_6in4_secondary_dns" size="30" maxlength="39" value=''></td>
				</tr>
				</table>
			</div>
			...
			<div class=box id=lan_ipv6_settings>
				...
				<tr>
					...
					<td width="331">&nbsp;
						<input type=text id="ipv6_6in4_lan_ip" name="ipv6_6in4_lan_ip" size="30" maxlength="63" value='' onChange="set_ipv6_autoconf_range()">
					<b>/64</b>
				</td>
				</tr>
				<tr>
