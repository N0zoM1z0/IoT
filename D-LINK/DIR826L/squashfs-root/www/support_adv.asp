	...
	<table id="topnav_container" border="1" cellpadding="2" cellspacing="0" width="838" height="100%" align="center" bgcolor="#FFFFFF" bordercolordark="#FFFFFF">
		<tr>
		  <td id="sidenav_container" valign="top" width="125" align="right">
				...
				<input type="hidden" id="html_response_lang" name="html_response_lang" value="support_adv.asp">
                  ...
                  <DL>
                    ...
                    <DD>
                      ...
                      <P>
					   ...
					   <P>
                        <script>show_words(help_auto_disable_hw_nat)</script>
                       </P>
                    </DD>
                  </DL>
            ...
            <td> <DL>
                ...
                <DD>
                  <DL>
                    ...
                    <DT>
                      <script>show_words(LW6_1)</script>
              ...
              <td>
				...
				<div class="box">
					...
					<tr>
						...
						<DD>
						<P><script>show_words(help_171)</script></P>
						</DL>
						</td>
					</tr>
					</table>
				...
				<div class="box">
					...
					<tr>
						...
						<DL>
						<DD>
						<P><script>show_words(IPV6_TEXT170)</script></P>
						</DL>
						</td>
					</tr>
					</table>
