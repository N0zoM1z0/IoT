...
var dev_info = get_router_info();
	...
	param.arg +="&oid_2=IGD_WANDevice_i_WANIPv6ConnectionDevice_i_AutoConfiguration_i_&inst_2=11110";	
	...
	//IPv6 DNS settings
	var auto_dns_enable = config_val("ipv6AutoConfConn_AutomaticDNSServer_");;

	//LAN IPv6 address settings
	var lan_ipv6_linklocal_addr = filter_ipv6_addr(filter_ipv6_addr(config_val("igdIPv6Status_IPv6LanLinkLocalAddress_")));
    ...
    function onPageLoad()
    {
		...
		$('#ipv6_stateless_primary_dns').val(filter_ipv6_addr(config_val("ipv6AutoConfConn_PrimaryDNSAddress_")));
		$('#ipv6_stateless_secondary_dns').val(filter_ipv6_addr(config_val("ipv6AutoConfConn_SecondaryDNSAddress_")));

		//LAN IPv6 address settings
		$('#ipv6_stateless_lan_ip').val(filter_ipv6_addr(config_val("lanIPv6Cfg_AutoConfigurationLanAddress_")));
    ...
    function disable_ipv6_stateless_auto_dns()
	{
		...
		if(fixIP[0].checked)
		{
			$('#ipv6_stateless_primary_dns').val(filter_ipv6_addr(config_val('igdIPv6Status_PrimaryDNSAddress_')));
			$('#ipv6_stateless_secondary_dns').val(filter_ipv6_addr(config_val('igdIPv6Status_SecondaryDNSAddress_')));
		}
		else
		{
			$('#ipv6_stateless_primary_dns').val(filter_ipv6_addr(config_val("ipv6AutoConfConn_PrimaryDNSAddress_")));
	...
	function disable_ipv6_dhcp_pd_chk(){	//20120207 fix with 835
		...
		{
			$('#ipv6_stateless_lan_ip').val(filter_ipv6_addr(config_val('igdIPv6Status_IPv6LanAddress_')));
	...
	function submit_aconfig()
	{
		...
		paramAdetect.arg += "&wanIPv6ConnDev_CurrentConnObjType_1.1.1.0.0=2";

		paramAdetect.arg += "&ipv6AutoConfConn_AutomaticDNSServer_1.1.1.1.0="+get_radio_value(get_by_name("ipv6_dns_stateless_enable"));
		paramAdetect.arg += "&ipv6AutoConfConn_PrimaryDNSAddress_1.1.1.1.0="+$('#ipv6_stateless_primary_dns').val();
		paramAdetect.arg += "&ipv6AutoConfConn_SecondaryDNSAddress_1.1.1.1.0="+$('#ipv6_stateless_secondary_dns').val();
		paramAdetect.arg += "&lanIPv6Cfg_DHCPPDEnable_1.1.1.0.0="+get_checked_value($('#ipv6_dhcp_pd_chk')[0]);
		paramAdetect.arg += "&lanIPv6Cfg_AutoDHCPPDEnable_1.1.1.0.0="+get_checked_value($('#ipv6_dhcp_pd_lan')[0]);
		paramAdetect.arg += "&lanIPv6Cfg_AutoConfigurationLanAddress_1.1.1.0.0="+$('#ipv6_stateless_lan_ip').val();
