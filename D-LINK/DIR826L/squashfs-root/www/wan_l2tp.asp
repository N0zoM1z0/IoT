...
<script language="JavaScript">
    ...
    function onPageLoad()
    {
		...
		get_by_id("wan_primary_dns").value= ipDNSServ[0];
	...
	function send_request(){
        ...
        var mtu_msg = replace_msg(check_num_msg, " MTU", 1300, 1400);
              ...
              <div class=box id=show_l2tp>
                ...
                <td align=right class="duple">
                  ...
                  :</td>
                      ...
                      <td>&nbsp;
                        <input type=text id="wan_l2tp_server_ip" name="wan_l2tp_server_ip" size="20" maxlength="63" value='<% CmoGetCfg("wan_l2tp_server_ip","none"); %>'>
                      </td>
                    </tr>
                    <tr>
