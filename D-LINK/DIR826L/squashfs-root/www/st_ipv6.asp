	...
	function onPageLoad()
	{
		...
		switch(v6Status.connType)
		{
			...
			case "2":   //autoconfiguration
				connection_type = "Auto Configuration (SLAAC/DHCPv6)";
				if (v6Status.netState != "Disconnected")
			...
			case "9":   //6rdAutoConfig
				connection_type = "Auto Configuration (SLAAC/DHCPv6) + 6RD";
				if (v6Status.netState != "Disconnected")
					tr_ipv6_show_button.style.display="";
				show_dhcppd(1);
				get_v6_gw(0);
		...
		if(v6Status.connType=="1"){
			if(use_linklocal_addr == "1")
				$('#wan_ipv6_addr').html((v6Status.wanLL == "")?"":(v6Status.wanLL+"/"+v6Status.WanPrefixLen));
		}
		...
		<div id="maincontent">
			...
			<div class="box">
				...
				<tr id="tr_ipv6_conn_time">
					...
					<td width="300">&nbsp;
						<span id="ipv6_conn_time" nowrap></span>&nbsp;<!--span id="ctrl_buttons"></span-->
					</td>
				</tr>
				<tr id="tr_ipv6_show_button">
					<td >&nbsp;</td>
					<td width="300">&nbsp;&nbsp;<span id="show_button"></span><span id="ctrl_buttons"></span></td>
				</tr>
				<tr id="tr_wan_ipv6_addriana">
					<td rowspan=2 align=right  nowrap><b><script>show_words(TEXT071)</script> :</b></td>
					<td width="300">&nbsp;
						<span id="wan_ipv6_addriana" nowrap></span>
						<span id="wan_ipv6_StaticIP" nowrap></span>
					</td>
				</tr>
