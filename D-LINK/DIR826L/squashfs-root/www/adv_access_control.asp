...
<script language="JavaScript">
	...
	function p8_onSubmit(inst)
	{
		...
		inst = new String(inst).replace(/,/g, '.');
		...
		param.arg += '&accessPolicy_Name_'+inst+'='+$('#p3_name').val();
			...
			<div class=box> 
				...
				<tr>
					...
					<td width="485">
						...
						<select id="p5_ip_list" name="ip_list" onChange="p5_selOnChange(this,'ip');">
				...
				<tr>
					...
					<td width="485">
						...
						<select id="p5_mac_list" name="mac_list" onChange="p5_selOnChange(this,'mac');">
							<option value=-1><script>show_words(bd_CName)</script></option>
							<script>
							//set_host_list( 'mac' );
