      ...
      <tr>
        ...
        <table id="topnav_container" border="1" cellpadding="2" cellspacing="0" width="838" height="100%" align="center" bgcolor="#FFFFFF" bordercolordark="#FFFFFF">
                       ...
                       <P><script>show_words(help254)</script> </P>
                                    <DL>
                                      ...
                                      <DL>
                                        ...
                                        <P><SPAN class=option><script>show_words(bwn_PPTPSIPA)</script>: </SPAN><script>show_words(help265_7)</script> </P>
                        ...
                        <P><SPAN class=option><script>show_words(help268)</script> </SPAN><script>show_words(help286)</script> </P>
                                      ...
                                      <DT>
                                      <DD>									  <DT><script>show_words(help_hw_nat)</script>
									  <DD><script>show_words(help_hw_nat_desc)</script>
									  <DT>
                                      <DD>
				...
				<div class="box">
					...
					<tr>
						<td>
						<DL><P><DD><script>show_words(help_stor1)</script></P>
						</DL>
						<DL>
						<DT><script>show_words(sto_http_1)</script>
						<DD><P><script>show_words(help_stor2)</script></P></DD>
						</DL>
						<DL>
						<DT><script>show_words(sto_http_3)</script>
						<DD><P><script>show_words(help_stor3)</script> </P></DD>
						</DL>
						<DL>
						<DT><script>show_words(sto_http_5)</script>
						<DD><P><script>show_words(help_stor4)</script> </P></DD>
						</DL>
						<DL>
