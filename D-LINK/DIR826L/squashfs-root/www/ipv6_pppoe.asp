...
<script>
	...
	function onPageLoad()
	{
		...
		$('#ipv6_pppoe_ipaddr').val(filter_ipv6_addr(config_val("ipv6PPPoEConn_ExternalIPAddress_")));
		$('#ipv6_pppoe_username').val(config_val("ipv6PPPoEConn_Username_"));
		$('#ipv6_pppoe_password_s').val(config_val("ipv6PPPoEConn_Password_"));
		$('#ipv6_pppoe_password_v').val(config_val("ipv6PPPoEConn_Password_"));
	...
	function disable_ipv6_poe_ip(){
		...
		$('#ipv6_pppoe_ipaddr').attr('disabled',fixIP[0].checked);
	}
		...
		<div id="maincontent">
			...
			<div class=box id=wan_ipv6_pppoe_settings>
				...
				<tr>
					...
					<td>&nbsp;
						<input type=radio name="ipv6_pppoe_connect_mode" value="0" onClick="check_ipv6_pppoe_connectmode()">
						<script>show_words(bwn_RM_0)</script>
						<input type=radio name="ipv6_pppoe_connect_mode" value="2" onClick="check_ipv6_pppoe_connectmode()" checked>
						<script>show_words(bwn_RM_1)</script>
						<input type=radio name="ipv6_pppoe_connect_mode" value="1" onClick="check_ipv6_pppoe_connectmode()">
				...
				<tr>
					...
					<td>&nbsp;
						<input type=text id="ipv6_pppoe_idle_time" name="ipv6_pppoe_idle_time" size="10" maxlength="5" value=''>
