...
//			get_by_id("reboot_type").value = "wlanapp";
	...
	function show_buttons(){
		...
		//2013/12/31 GraceYang Add: if security mode not support, add wireless device with WPS button should be gray.
		var wlan0_security = "<!--# echo wlan0_security -->";
		var wlan1_security = "<!--# echo wlan1_security -->";
		...
		if(wlan0_security == "wpa2auto_eap" || wlan0_security == "wep_auto_64" ||  wlan0_security == "wep_auto_128" 
		||wlan0_security == "wep_share_64" ||  wlan0_security == "wep_share_128" 
                || wlan1_security == "wpa2auto_eap" || wlan1_security == "wep_auto_64"|| wlan1_security == "wep_auto_128"
                ||wlan1_security == "wep_share_64" ||  wlan1_security == "wep_share_128" ){
			get_by_id("wps_wizard").disabled = true;
		}else{
			get_by_id("wps_wizard").disabled = false;
		}
	...
	<table border="1" cellpadding="2" cellspacing="0" width="838" height="100%" align="center" bgcolor="#FFFFFF" bordercolordark="#FFFFFF">
		<tr>
		  <td id="sidenav_container" valign="top" width="125" align="right">
			...
			<input type="hidden" id="wps_default_pin" name="wps_default_pin" value="<!--# echo wps_default_pin -->">
