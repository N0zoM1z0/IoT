                      ...
                      <tbody>
                        ...
                        <script>
							...
							for(var i=0 ; i<rule_max_num ; i++){
								...
								document.write("<td>"+_name+"<br><input type=\"text\" class=flatL id=\"name" + i + "\" size=16 maxlength=15 value=\""+ obj_Name +"\"></td>")
								document.write("<td>"+_destip+"<br><input type=\"text\" class=flatL id=\"Destination" + i + "\" size=16 maxlength=15 value=\""+ obj_IP +"\"></td>")
								document.write("<td align=center rowspan=2><input type=\"text\" class=flatL id=\"metric" + i + "\" size=16 maxlength=15 value=\""+ obj_metric +"\"></td>")
								document.write("<td align=center rowspan=2>&nbsp;");
								document.write("<select style='width:90' id=\"interface" + i +"\">");
								...
								document.write("<tr>")
								document.write("<td>"+_netmask+"<br><input type=\"text\" class=flatL id=\"Sub_Mask" + i + "\" size=16 maxlength=15 value=\""+ obj_Mask +"\"></td>")
								document.write("<td>"+_gateway+"<br><input type=\"text\" class=flatL id=\"Sub_gateway" + i + "\" size=16 maxlength=15 value=\""+ obj_gateway +"\"></td>")
