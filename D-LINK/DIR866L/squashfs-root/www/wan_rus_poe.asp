...
function send_pppoe_request(){
	...
	if ("<!--# echo wan_proto -->" == "pppoe" && "<!--# echo wan_pppoe_russia_enable -->" == "0")
	...
	<table border="1" cellpadding="2" cellspacing="0" width="838" height="100%" align="center" bgcolor="#FFFFFF" bordercolordark="#FFFFFF">
		<tr>
			...
			<form id="form1" name="form1" method="post" action="apply.cgi">
				...
				<input type="hidden" id="html_response_return_page" name="html_response_return_page" value="wan_rus_poe.asp">
				<input type="hidden" id="action" name="action" value="wan_rus_poe">
				...
				<input type="hidden" id="wan_pppoe_russia_enable" name="wan_pppoe_russia_enable" value="1">
			...
			<!-- <option value="dslite">DS-Lite</option> -->
						...
						<option value="pppoe" selected><script>show_words(bwn_Mode_RUS_PPPoE)</script></option>
						<script>
		...
		<!--HARDWARE NAT SETTING START-->
			...
			<table cellSpacing=1 cellPadding=1 width=525 border=0>
              ...
              <div class=box id=show_rus_poe >
                <h2><script>show_words(bwn_RUSPOEICT);</script></h2>
			...
			<div class=box id=show_wan_physical>
