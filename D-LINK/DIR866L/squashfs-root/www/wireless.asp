	...
	function send_request(){	
		...
		if(get_by_id("w_enable_1").checked)
		{
			if(wep_type_value_1 == 1){		//WEP
				...
				if (wlan1_dot11_mode == "11ac_only" || wlan1_dot11_mode == "11ac_11n"){
					alert(MSG049);
					return false;
				}else{
					if(!check_key_1()){
				...
				if ((wlan1_dot11_mode == "11ac_only" || wlan1_dot11_mode == "11ac_11n") && (c_type_1_value == "tkip")){
					alert(MSG050);
					return false;
				}else{
					if (!check_varible(temp_rekey_1)){
...
//Display DFS channel  
	...
	function reset_channel(ch)
	{
		...
		var pt_11ac = $("#11ac_protection").val();
...
<br>
<div id="copyright">Copyright &copy; 2004-2015 D-Link Corporation, Inc.</div>
<br>
</body>
