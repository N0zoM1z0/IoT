...
<script language="JavaScript">
	...
	function onPageLoad(){
		...
		set_checked("<!--# echo ipv6_autoconfig_dns_enable -->", get_by_name("ipv6_dns_autoconfig_enable"));
	...
	<table border="1" cellpadding="2" cellspacing="0" width="838" height="100%" align="center" bgcolor="#FFFFFF" bordercolordark="#FFFFFF">
		<tr>
		  ...
		  <div id=box_header>
                    ...
                    <input name="button2" id="button2" type="button" class=button_submit value="" onclick="return page_cancel('form1', 'adv_ipv6_autoconfig.asp');">
	         ...
	         <div class=box id=wan_ipv6_settings>
	                ...
	                <table cellSpacing=1 cellPadding=1 width=525 border=0>	
	                    ...
	                    <tr>
	                      ...
	                      <td width="331">&nbsp;<input type=text id="ipv6_autoconfig_primary_dns" name="ipv6_autoconfig_primary_dns" size="30" maxlength="39" value="<!--# echo ipv6_autoconfig_primary_dns -->"></td>
	                    </tr> 
	                    <tr>
	                      <td width="187" align=right class="duple"><script>show_words(_dns2);</script> :</td>
	                      <td width="331">&nbsp;<input type=text id="ipv6_autoconfig_secondary_dns" name="ipv6_autoconfig_secondary_dns" size="30" maxlength="39" value="<!--# echo ipv6_autoconfig_secondary_dns -->"></td>
	                    </tr>
	                </table>
                 </div>
		 <div class=box id=lan_ipv6_settings>
			...
			<td width="331" align=left>&nbsp;<b>
				...
				<script>show_words(_minutes);</script><script>show_words(_optional);</script>
	                      ...
	                      <td width="331">&nbsp;
	                      	<input type=text id="ipv6_autoconfig_lan_ip" name="ipv6_autoconfig_lan_ip" size="30" maxlength="63" value="<!--# echo ipv6_autoconfig_lan_ip -->" onChange="set_ipv6_autoconf_range()"> 
	                      	<b>/64</b>
	                      </td>
			    </tr> 
			    <tr> 
