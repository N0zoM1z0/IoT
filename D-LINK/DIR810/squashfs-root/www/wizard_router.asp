...
<script language="JavaScript">
	...
	var nextPageArray = new Array('p3', 'p2', 'p9', 'p4', 'p5', 'p6', 'p7a', 'p8', 'p8', 'p8', 
								  ...
								  'p13','p13a','p13b', 'p15','p15','p14', 'p15','Unknown');
	...
	function submit_all()
	{
		...
		//2014-02-20 Silvia, Support WFA 1.00 need to send ccpSubEvent3 for change samba password
		if (is_WFA100)
		{
			var paramSubmitSMB = {
				url: "easy_setup.ccp",
			...
			var paramStrSMB = "ccp_act=set&ccpSubEvent=CCP_SUB_WEBACCESS_SMB_PASSWD&nextPage=sel_wan.asp";
			paramSubmitSMB.arg += paramStrSMB;
			get_config_obj(paramSubmitSMB);
		}
	}
	...
	function submit_wifi(gotopage)
	{
		...
		paramSubmit.arg += paramStr;
		paramSubmit.arg += '&igd_AlreadyConfiguration_1.0.0.0.0=1';
		ajax_submit_new(paramSubmit,false);
	...
	function submit_regist(val)
	{
		...
		{
			//show_mydlink_start_str='mydlink_pop_05'
				...
				switch(action)
				{
					...
					case 2:	//adddev
						...
						{							
							...
							if(!is_wifi_change())
								paramStr.arg += '&igd_AlreadyConfiguration_1.0.0.0.0=1';
							paramStr.arg += '&ccpSubEvent=CCP_SUB_WAN';	//Jerry, add sub event							
...
*/
	...
	function constructParamL2TP()
	{
		...
		paramStr += "&l2tpCfg_SubnetMask_1.1.1.1.0=" + $('#l2tp_mask').val();
...
<!-------------------------------->
		<div class=box id="p3" style="display:none"> 
			...
			<div align="center">
				<img src="netowrk-topology_1.03.png" width="603" height="246">
			</div>
			<div> 
				<table align="center" class="formarea">
				<tr>
			...
			<div align="left"> 
				...
				<div>
					...
					<tr>
						<td>&nbsp;</td>
						<td> 
							<input name="clone" type="button" class="button_submit" id="clone_3" value="" onClick='clone_mac_action("dhcpplus_wan_mac");'>
							<script>$('#clone_3').val(get_words('_clone'));</script>
						</td>
					</tr>
					<tr>
						<td align="right" class="duple">
		...
		<h2 align="left"><script>show_words(ES_title_s6)</script></h2>
			<table class=formarea>
				<tr height="24"><br>
					...
					<td width="45%">
						<input type="text" id="email_addra" name="email_addra" value="" maxlength="128">
					</td>
				</tr>
				<tr height="24"><br>
					<td></td>
