...
<script language="JavaScript">
	...
	var	param = {
		...
		arg: "ccp_act=get&num_inst=14"+
			...
			"&oid_14=IGD_AdministratorSettings_LoginInfo_i_&inst_14=11100"
	};
...
var adminpwd = config_val("loginInfo_Password_");
...
var wlanCfg = {
	...
	function constructParamPPPoE()
	{
		...
		paramStr += "&pppoeCfg_ServiceName_1.1.1.1.0=" + urlencode(get_by_id("pppoe_service").value);
...
<!-------------------------------->
		<div class=box id="p1"> 
			...
			<p class="box_msg">
				<script>show_words(wwa_intro_s1a)</script>
			</p>
			<!--
		...
		<div class=box id="p3"> 
			...
			<div> 
				<P align="left" class=box_msg>
					<script>show_words(wwa_intro_s3a)</script>
				</P>
				<!--
...
<!-------------------------------->
		<div class=box id="p4c"> 
			...
			<div>
				<!--
				<form id="form4c" name="form4c" method="post" action="">
				-->
					<table class=formarea >
					<tr>
...
<!-------------------------------->
		<div class=box id="p4d"> 
			...
			<div align="left"> 
				...
				<!--
				<form id="form4d" name="form4d" method="post" action="">
				-->
					<div>
...
<!-------------------------------->
		<div class=box id="p4e"> 
			...
			<div align="left"> 
				...
				<div>
					<!--
					<form id="form4e" name="form4e" method="post" action="">	
					-->
						<table width="536" align="center" class=formarea>
						<tr>
							<td width="235" align=right class="duple">
...
<!-------------------------------->
		<div class=box ID="p4f"> 
			...
			<!--
			<form id="form4f" name="form4f" method="post" action="">
			-->
				<table width="536" align="center" class=formarea >
				<tr>
...
<!-------------------------------->
		<div class=box id="p5"> 
			...
			<div align="left">
				<div> 
					<P align="left" class=box_msg>
						<script>show_words(wwa_intro_s5)</script>
					</P>
						<table align="center" class=formarea >
						<tr>
							<td></td>
