...
var	tt_StDT="Set the Date a.d Time Manually";
...
var	wwa_pptp_svraddr="PPTP Server IP Address (may be same as gateway)";
...
var	help261="Some ISP's may check your computer's Host Name. The Host Name identifies your system to the ISP's server. This way they know your computer is eligible to receive an IP address. In othether words, they know that you are paying for their service.";
...
var	anet_multicast_enable="Enable Multicast Streams";
...
var	up_tz_11="(GMT-05:00)  Bogota, Lima, Quito";
...
var	ddns_disconnect="Disconnect";
...
var	up_tz_51="(GMT+06:00) Sri Jayawardenepura";
...
var	_yes="Yes";
var	help699="SSID";
var	up_tz_62="(GMT+09:00) Yakutsk";
...
var	up_tz_45="(GMT+05:00) Ekaterinburg";
...
var	help901="Displays the current status of connection to DDNS server.";
...
var	up_tz_69="(GMT+10:00) Vladivostok";
...
var	up_tz_19="(GMT-03:00) Buenos Aires, Georgetown";
...
var	gw_gm_75="KALI";
var	help604="Layer 2 Tunneling Protocol";
...
var	up_tz_00="(GMT-12:00) Eniwetok, Kwajalein";
...
var	up_tz_15="(GMT-04:00) Caracas, La Paz";
...
var	up_tz_01="(GMT-11:00) Midway Island, Samoa";
...
var	anet_multicast="Multicast Streams";
...
var	up_tz_56="(GMT+08:00) Irkutsk, Ulaan Bataar";
...
var	help506="Sending and Receiving data transmissions at the sane time";
var	wps_lost="This will cause all wireless settings to be lost.";
var	help26="Note:";
var	up_tz_35="(GMT+02:00) Helsinki, Riga, Tallinn";
var	help642="A sequence of characters that is used to authenticate requests to resources on a network";
var	bwn_intro_ICS="Use this section to configure your Internet Connection type. There are several connection types to choose from Static IP, DHCP, PPPoE, PPTP, L2TP. If you are unsure of your connection method, please contact your Internet Service Provider.";
...
var	up_tz_20="(GMT-03:30) Greenland";
...
var	tf_CFWD="Current Firmware Date";
...
var	help704="Syslog";
var	help758="WLAN";
var	up_tz_25="(GMT) Greenwich Time Dublin, Edinburgh, Lisbon, London";
var	help634="NIC";
...
var	up_tz_49="(GMT+06:00) Almaty, Novosibirsk";
...
var	wwa_msg_set_pptp="To set up this connection you will need to have a Username and Password from your Internet Service Provider. You also need PPTP IP adress. If you do not have this information, please contact your ISP.";
...
var	ta_intro1="The \"admin\" and \"user\" accounts can access the management interface. The admin has read/write access and can change passwords, while the user has read-only access.";
var	help561="IGMP";
var	help442="Bit/sec";
var	tt_week_3="3rd";
...
var	up_tz_09="(GMT-06:00) Mexico City";
var	tt_Jul="Jul";
...
var	wps_messgae1_1="Please start WPS on the wireless device you are adding to your wireless network winth";
...
var	wwa_l2tp_svra="L2TP Server IP Address (may be same as gateway)";
...
var	wps_messgae1_2="Please press down the Push Button (physical or virtual) on the wireless device you are adding to your wireless network within";
...
var	hhta_pw="For security reasons, it is recommended that you change the password for the Admin and User accounts. Be sure to write down the new and passwords to avoid having to reset the router in case they are forgotten.";
...
var	up_tz_39="(GMT+03:00) Moscow, St. Petersburg, Volgograd";
...
var	up_tz_70="(GMT+11:00) Magadan, Solomon Is., New Caledonia";
...
var	tsc_hrmin="(hour minute, 12 hour time)";
...
var	help91="The priority of the message flow is entered here -- 1 receives the highest priority (most urgent) and 255 receives the lowest priority (least urgent).";
...
var	help802="If you provided email information with the <a href='tools_email.asp'>Tools&nbsp;&rarr;&nbsp;Email</a> screen, clicking the <span class='button_ref'>Email Now</span> button sends the router log to the configured email address.";
...
var	help890="When this option is enabled, an email will be sent to the email address configured in the email section whenever new firmware is available. You must have Email Notification enabled from the <a href='tools_email.asp'>Tools&nbsp;&rarr;&nbsp;Email</a> screen.";
...
var	rb_change="If you changed the IP address of the router you will need to change the IP address in your browser before accessing the configuration Web site again.";
...
var	hhsl_lmail="You can also have the log mailed to you periodically. Refer to <a href='tools_email.asp' onclick='return jump_if();'>Tools &rarr; EMail</a>.";
...
var	gw_wcn_err_bad_wps_profile="Cannot create the wirless profile XML file";
...
var	up_tz_27="(GMT+01:00) Belgrade, Brastislava, Budapest, Ljubljana";
var	up_tz_29="(GMT+01:00) Sarajevo, Skopje, Sofija, Vilnus, Warsaw, Zagreb";
...
var	aa_AT_2="Others";
var	_copyright="Copyright &copy; 2004-2006 DLink, Inc.";
...
var	at_alert_1="Max transmission rate should be between 20 kbps and 2 Mbps, inclusive.";
...
var	bws_alert_16="WEP Key '+ wep_error_msg + ' is invalid.";
...
var	YM2="Your changes have been saved. The router must be rebooted for the changes to take effect. You can reboot now, or you can continue to make other changes and reboot later.";
...
var	GW_DYNDNS_SERVER_INDEX_VALUE_INVALID="invalid server index value %d";
var	WARN="[WARN]";
var	LW23="Enterprise";
...
var	LW9="Current PIN";
var	LW41="This wizard is designed to assist you in your wireless network setup. It will guide you through step-by-step instructions on how to set up your wireless network and how to make it secure.";
...
var	logs_LW39b_email="email,The Email Now button is disabled because Email Notification is not enabled on <a href='tools_email.asp' onclick='return jump_if();' shape='rect'>Tools &rarr; Email</a> screen.";
var	LV3="Use HTTPS";
...
var	IPV6_TEXT1="Please change IPv6 WAN protocol first!";
...
var	IPV6_TEXT13="Select this option if you require any wireless device attempting to communicate with the router to provide the encryption key needed to access the network before being allowed to communicate with the DIR-652.";
...
var	IPV6_TEXT15="The Key Types that are supported by the DIR-652 are HEX (Hexadecimal) and ASCII (American Standard Code for Information Interchange.) The Key Type can be changed to suit an existing wireless network or to customize your wireless network.";
...
var	IPV6_TEXT21="DIR-652 supports two different cipher types when WPA is used as the Security Type. These two options are TKIP (Temporal Key Integrity Protocol) and AES (Advanced Encryption Standard).";
...
var	IPV6_TEXT25="This will be needed by your wireless clients in order to communicate with your DIR-652, when PSK is selected. Enter 8 to 63 alphanumeric characters. Be sure to write this Passphrase down as you will need to enter it on any other wireless devices you are trying to add to your network.";
...
var	IPV6_TEXT35="IPv6 over IPv4 Tunnel";
var	IPV6_TEXT36="6to4";
var	IPV6_TEXT37="Link-local only";
var	IPV6_TEXT38="IPv6 over IPv4 TUNNEL SETTINGS";
var	IPV6_TEXT39="Enter the IPv6 over IPv4 Tunnel information provided by your Tunnel Broker.";
...
var	IPV6_TEXT50="Enable Autoconfiguration";
...
var	IPV6_TEXT67="Use this section to configure the internal network settings of your router.The LAN IPv6 Link-Local Address is the IPv6 Address that you use to access the Web-based managment interface";
...
var	IPV6_TEXT88="If your ISP has assigned a fixed IPv6 address, select this option. The ISP provides the value for the <SPAN class=option>IPv6 Address.";
...
var	IPV6_TEXT90="IPv6 over IPv4 Tunnel Mode";
var	IPV6_TEXT91="IPv6 over IPv4 tunneling encapsulate of IPv6 packets in IPv4 packets so that IPv6 packets can be sent over an IPv4 infrastructure. ";
...
var	TEXT000="D-Link Corporation | WIRELESS ROUTER | HOME";
...
var	TEXT013="Inbound filter must be smaller than + rule_max_num";
...
var	TEXT029="The WPS Function is currently set to disabled. Please click \"Yes\" to enable it or \"No\" to exit the wizard.";
var	TEXT030="The %s cannot allow loopback IP or multicase IP (127.x.x.x, 224.x.x.x ~ 239.x.x.x) entries.";
var	TEXT031="The %s port entered is invalid.";
var	TEXT032="The %s secret entered is invalid.";
...
var	TEXT054="obj_word + ' conflict with Port Forwarding Port.'";
var	TEXT055="obj_word + ' conflict with Application Firewall Port.'";
var	TEXT056="obj_word + 'conflict with Virtual Server Port.'";
...
var	MSG008="The %s port entered is invalid.";
var	MSG009="The %s secret entered is invalid";
...
var	MSG040="The suffix of IPv6 Address Range(Start) is more than the suffix of IPv6 Address Range(End)";
...
var _date="Date";
var tf_CLPV="Current Language Pack Version";
var tf_LLPV="Latest Language Pack Version";
var tf_LLPD="Latest Language Pack Date";
var _nalp="No Language Pack";
var _remove="Remove";
var tf_COLFL="Check Online Now for Latest Firmware and Language pack Version";
var _clearlp="Remove Language Pack";
