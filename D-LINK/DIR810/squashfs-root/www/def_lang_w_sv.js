...
var which_lang = new Array ( //_NO_SHARE_NAME_
	...
	"Routern identifierar din typ av Internet-anslutning, vänta…", //ES_auto_detect_desc
	"Routern kan inte känna av din typ av Internet-anslutning.", //ES_auto_detect_failed_desc
	"Vill du lägga till \"D-Link Router Web Management\" som bokmärke?", //ES_bookmark
	"Försök igen", //ES_btn_try_again
	"Anslut ena änden av Ethernet-kabeln som medföljer routern till porten märkt INTERNET på baksidan av routern. Anslut den andra änden av kabeln till Ethernet-porten på ditt modem och stäng sedan av och slå på modemet.", //ES_cable_lost_desc
	...
	"Version av programvara", //sd_FWV
	"Produktsida", //TA2
	"Maskinvaruversion", //TA3
	...
	"Välj rätt tidszon för din ort. Denna information krävs för att konfigurera tidsbaserade alternativ. Routern ställs in så att den interna klockan automatiskt uppdateras från en NTP-server.", //wwa_intro_s2
	...
	"Välj detta alternativ om din Internet-anslutning kräver ett användarnamn och lösenord för att gå online. De flesta DSL-modem använder denna typ av anslutning.", //wwa_msg_pppoe
	...
	"Kan inte logga in till mydlink.", //mdl_errmsg_01
	"Det gick inte att skicka inloggningsbegäran.", //mdl_errmsg_02
	"Kan inte skicka inloggningsbegäran.", //mdl_errmsg_03
	"Det gick inte att skicka registreringsbegäran.", //mdl_errmsg_04
	"Kan inte skicka registreringsbegäran.", //mdl_errmsg_05
	"SSID-fältet får inte vara tomt", //SSID_EMPTY_ERROR
	"De angivna lösenorden stämmer inte överens", //YM102
	"Ett PPPoE-lösenord MÅSTE anges", //GW_WAN_PPPoE_PASSWORD_INVALID
	"Kontots lösenord måste vara minst sex tecken", //limit_pass_msg
	"Hoppa över", //_skip
	...
	"Denna enhet är mydlink-aktiverad, vilket gör att du kan fjärrövervaka och -hantera ditt nätverk via webbplatsen mydlink.com eller med den mobila appen mydlink.", //_wz_mydlink_into_1
	"Du kan kontrollera nätverkets hastighet, se vem som är ansluten, visa webbhistorik och få meddelanden om nya användare och intrångsförsök.", //_wz_mydlink_into_2
	"Du kan registrera denna enhet med ditt befintliga mydlink-konto. Om du inte har något så kan du skapa ett nu.", //_wz_mydlink_into_3
	"Kontrollera din inkorg efter ett meddelande med anvisningar för bekräftelse.", //_wz_mydlink_email_1
	"Routern kontrollerar Internet-anslutningen, vänta.", //_chk_wanconn_msg_00
