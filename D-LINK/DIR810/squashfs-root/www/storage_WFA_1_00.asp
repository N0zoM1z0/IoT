...
<script language="JavaScript">
	...
	var guest_enable = config_val('igdStorage_GuestEnable_'); 
...
*/
		...
		if (guest_enable != gu_en)
			paramSet.arg += "&ccpSubEvent2=CCP_SUB_WEBACCESS_ADMIN";
		
		submitData += "&igdStorage_Enable_1.1.0.0.0="+wa_en;
		submitData += "&igdStorage_GuestEnable_1.1.0.0.0="+gu_en;
