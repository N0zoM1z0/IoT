...
var which_lang = new Array ( //_NO_SHARE_NAME_
	...
	"Zapojte jeden konec přibaleného ethernetového kabelu do portu s označením INTERNET na zadní straně směrovače. Zapojte druhý konec tohoto kabelu do ethernetového portu modemu, poté modem vypněte a znovu zapněte.", //ES_cable_lost_desc
	...
	"Auto (WPA nebo WPA2) – Personal", //KR48
	...
	"(GMT+01:00) Amsterdam, Berlín, Bern, Řím, Stockholm, Vídeň", //up_tz_26
	"(GMT+01:00) Bělehrad, Bratislava, Budapešť, Ljubljana, Praha", //up_tz_27
	...
	"(GMT+04:00) Moskva, St. Petěrburg, Volgograd", //up_tz_39
	...
	"(GMT+11:00) Šalamounovy ostrovy, Nová Kaledonie", //up_tz_70
	...
	"(GMT-12:00) Západní strana mezinárodní datové hranice", //up_tz_76
	"(GMT-11:00) Ostrov Midway", //up_tz_77
	"(GMT-07:00) Chihuahua, La Paz, Mazatlan", //up_tz_78
	"(GMT-06:00) Guadalajara, Mexico City, Monterrey", //up_tz_79
	"(GMT-05:00) Bogota, Lima, Quito, Indiana (východ)", //up_tz_80
	"(GMT-04:30) Caracas", //up_tz_81
	"(GMT-04:00) Georgetown, La Paz", //up_tz_82
	"(GMT-03:00) Buenos Aires", //up_tz_83
	"(GMT+01:00) Sarajevo, Skopje, Varšava, Záhřeb", //up_tz_84
	"(GMT+02:00) Helsinky, Kyjev, Riga, Sofia, Tallinn, Vilnius", //up_tz_85
	"(GMT+05:30) Čennaj, Kalkata, Bombaj, Nové Dillí", //up_tz_86
	"(GMT+07:00) Almaty, Novosibirsk", //up_tz_87
	"(GMT+05:30) Šrí Džajvardanapura", //up_tz_88
	"(GMT+08:00) Ulaanbátar", //up_tz_89
	...
	"Vyberte časové pásmo odpovídající vaší zemi. Tato informace je nutná ke konfiguraci časových možností. Na směrovači se nastaví automatická aktualizace vnitřních hodin z časového serveru NTP.", //wwa_intro_s2
	...
	"Tuto možnost vyberte, pokud vaše připojení k internetu vyžaduje uživatelské jméno a heslo. Tento typ připojení používá většina DSL modemů.", //wwa_msg_pppoe
	...
	"Zadaný port pro pole %s je neplatný.", //MSG008
	...
	"Zadejte jinou hodnotu v poli %s.", //MSG012
	"Hodnota %s musí být číselná.", //MSG013
	"Rozsah pro %s je %1n ~ %2n.", //MSG014
	"Hodnota v poli %s musí být sudá.", //MSG015
	...
	"1. část pole %s musí být hexadecimální.", //MSG018
	"2. část pole %s musí být hexadecimální.", //MSG019
	"3. část pole %s musí být hexadecimální.", //MSG020
	"4. část pole %s musí být hexadecimální.", //MSG021
	"5. část pole %s musí být hexadecimální.", //MSG022
	"6. část pole %s musí být hexadecimální.", //MSG023
	"7. část pole %s musí být hexadecimální.", //MSG024
	"8. část pole %s musí být hexadecimální.", //MSG025
	"1. část pole %s musí být v rozsahu", //MSG026
	"2. část pole %s musí být v rozsahu", //MSG027
	"3. část pole %s musí být v rozsahu", //MSG028
	"4. část pole %s musí být v rozsahu", //MSG029
	"5. část pole %s musí být v rozsahu", //MSG030
	"6. část pole %s musí být v rozsahu", //MSG031
	"7. část pole %s musí být v rozsahu", //MSG032
	"8. část pole %s musí být v rozsahu", //MSG033
	...
	"Nelze se přihlásit ke službě mydlink.", //mdl_errmsg_01
	"Odeslání požadavku na přihlášení se nezdařilo.", //mdl_errmsg_02
	"Nelze odeslat požadavek na přihlášení.", //mdl_errmsg_03
	"Odeslání požadavku na registraci se nezdařilo.", //mdl_errmsg_04
	"Nelze odeslat požadavek na registraci.", //mdl_errmsg_05
	"Pole SSID nemůže být prázdné", //SSID_EMPTY_ERROR
	"Zadaná hesla se neshodují", //YM102
	"Musí být zadáno heslo pro PPPoE", //GW_WAN_PPPoE_PASSWORD_INVALID
	"Heslo k účtu musí být delší než šest znaků", //limit_pass_msg
	"Přeskočit", //_skip
	...
	"Toto zařízení podporuje služby mydlink, které umožňují vzdáleně sledovat a spravovat síť prostřednictvím webu mydlink.com nebo mobilní aplikace mydlink.", //_wz_mydlink_into_1
	"Můžete zkontrolovat rychlosti sítě, podívat se, kdo je připojen, zobrazit si historii prohlížení internetu ze zařízení a nechat si zasílat upozornění na nové uživatele nebo pokusy o průnik.", //_wz_mydlink_into_2
	"Toto zařízení můžete zaregistrovat ke stávajícímu účtu mydlink. Pokud účet nemáte, můžete si jej nyní vytvořit.", //_wz_mydlink_into_3
	"Zkontrolujte si poštu, měli byste obdržet e-mail s pokyny, jak provést potvrzení.", //_wz_mydlink_email_1
	"Směrovač kontroluje připojení k internetu, čekejte prosím.", //_chk_wanconn_msg_00
