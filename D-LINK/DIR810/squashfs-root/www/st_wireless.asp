...
<script>
	...
	function loadWifiStatus()
	{
		...
		for (i=1;i<=4;i++){
			param.arg +="&oid_"+i+"=IGD_LANDevice_i_WLANConfiguration_i_&inst_"+i+"=11"+i+"00";
		}

		get_config_obj(param);
		WEnable = config_str_multi('lanWlanCfg_Enable_');
	}

	$(document).ready( function () {
		//2014-02-06 Silvia, do not paint the list if wireless disable.
		loadWifiStatus();
		loadWifiClientList();
	});
