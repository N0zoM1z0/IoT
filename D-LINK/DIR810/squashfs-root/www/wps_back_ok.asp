...
<tr>
	...
	<tr>
		...
		<tr>
			...
			<p>&nbsp;</p>
			<p align="center"><script>show_words(add_wireless_device)</script><script>show_words(YM9)</script>
			<p>&nbsp;</p>
			<p align="center">
				<input name="button" id="button" type=button class=button_submit value="" onClick="back()">
				<script>get_by_id("button").value = get_words('_ok');</script>
			</p>
			</div>
			</td>
		</tr>
