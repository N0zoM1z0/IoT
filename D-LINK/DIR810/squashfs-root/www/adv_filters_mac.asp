...
var param = {
	...
	arg: 	"ccp_act=get&num_inst=4&"+
			...
			"oid_4=IGD_LANDevice_i_WLANConfiguration_i_WPS_&inst_4=11110"
};
...
<table id="footer_container" border="0" cellpadding="0" cellspacing="0" width="838" align="center">
	...
	<form id="form2" action="get_set.ccp">
		...
		<input type="hidden" id="wps_enable1" name="wpsCfg_Enable_1.1.1.1.0" value="">
		<input type="hidden" id="wps_enable2" name="wpsCfg_Enable_1.1.3.1.0" value="">
		<script>
			for(var i=0; i<rule_max_num; i++)
			{
