...
var which_lang = new Array ( //_NO_SHARE_NAME_
	...
	"Select this option if you require any wireless device attempting to communicate with the router to provide the encryption key needed to access the network before being allowed to communicate with the DIR-810L.", //IPV6_TEXT13
	...
	"The Key Types that are supported by the DIR-810L are HEX (Hexadecimal) and ASCII (American Standard Code for Information Interchange.) The Key Type can be changed to suit an existing wireless network or to customize your wireless network.", //IPV6_TEXT15
	"Keys", //IPV6_TEXT16
	...
	"Max transmission rate should be between 8 kbps and 100 Mbps, inclusive.", //at_alert_1_2
	...
	"It will allow you to access files from a USB external hard drive or thumb drive that is plugged into the DIR-810L from your local network or from the Internet using either a web browser or the SharePort &trade; Mobile app for your smartphone or tablet. You can create users to customize access rights to the files stored on the USB drive. After making your changes, click the <strong>Save Settings</strong> button.", //help_stor1
	"Tick this checkbox to enable sharing files stored on a USB storage drive connected to the DIR-810L.", //help_stor2
	"Enter a port to use for HTTP web access to your files (8181 is the default). You will have to add this port to the IP address of the DIR-810L when connecting. For example: http://192.168.0.1:8181", //help_stor3
	"Enter a port to use for HTTPS secure access to your files (4433 is the default). You will have to add this port to the IP address of the DIR-810L when connecting. For example: https://192.168.0.1:4433", //help_stor4
	...
	"Metric value should be in between (1..16).", //_adv6_metric
	"Cannot accept space character at the begining and the end of name", //_wifi_ssid
	"Auto Configuration (SLAAC/DHCPv6)", //IPV6_TEXT171
	"Auto Configuration (SLAAC/DHCPv6) + 6RD", //IPV6_TEXT172
	"Ping Test", //_testing_
	"Unexpected server error", //drws_err_5001
	"No devices", //drws_err_5002
	"Authentication fail", //drws_err_5003
	"Path doesn't exist", //drws_err_5004
	"File doesn't exist", //drws_err_5005
	"Connection timeout", //drws_err_5006
	"The method is not implemented", //drws_err_5007
	"Disk full", //drws_err_5008
	"Destination file already exists", //drws_err_5009
	"The file system is read-only.", //drws_err_5010
	"File name too long", //drws_err_5011
	"Request expired", //drws_err_5101
	"Insufficient Permission", //drws_err_5102
	"Invalid user", //drws_err_5103
	"Invalid application ID", //drws_err_5104
	"Dynamic", //_dynamic
	"Static", //_static
	"USING PIN NUMBER", //_wps_use_pin
	"Source and destination interface can not be the same for %s", //_v6firewall_iface
	"Please select your Internet connection type below:", //wwa_intro_s3a
	"The Internet Connection Setup Wizard has completed. Click the Connect button to save your settings and reboot the router.", //wwa_intro_s5
	"By default, your new D-Link Router does not have a password configured for administrator access to the Web-based configuration pages. To secure your new networking device, please set and verify a password below:", //wwa_intro_s1a
	...
	"Error found in Dynamic DNS Setting, please try again.", //sh_port_tx_24
	"The Access Path of User [%s] can not be \"None\"", //sto_user_path
	"Metric value should be in between (1..15).", //ar_alert_3a
	"IPv6 wan type should be SLAAC/DHCPv6, PPPoE, Static IPv6, Autodetect Mode", //IPV6_TEXT173
	"Username / Password Connection (RUSSIA PPPoE)", //wwa_wanmode_rupppoe
	"Username / Password Connection (RUSSIA PPTP)", //wwa_wanmode_rupptp
	"Username / Password Connection (RUSSIA L2TP)", //wwa_wanmode_rul2tp
	"Set Username and Password Connection (RUSSIA PPPoE)", //wwa_title_set_rupppoe
	"Set Username and Password Connection (RUSSIA PPTP)", //wwa_title_set_rupptp
	"Set Username and Password Connection (RUSSIA L2TP)", //wwa_title_set_rul2tp
	"The clients should release and renew IP address or the DUT should be reboot.", //_LAN_CHK_REBOOT_MSG
	"You cannot add more machines because the table is full.", //TEXT079
	"Sending mail, please wait..", //sto_link_3
	"DFS Channel Enable", //DFS_TEXT001
	"DFS enables you to use more channels to help find one with the least interference. \n\nHowever, please note that when using DFS, the router must scan for radar signals for a minute before using a channel, and will change channels automatically if radar signals are detected.", //DFS_TEXT002
	"WINDOWS FILE SHARING (SAMBA)", //samba_title_up
	"Windows File Sharing (SAMBA)", //samba_title_low
	"Require router's admin password", //samba_admin
	"Allow all users to access (no password)", //samba_user
	"Please try again in %s seconds.", //invalid_cd
	"Shareport Access Link", //sto_http_7
	"http://shareport.local./", //sto_http_link
	"https://shareport.local./", //sto_https_link
	"Processing", //ddns_processing
	"This mail will be sent to email address", //sl_alert_4
	...
	"WPS will be disable when the MAC filter allow/deny function is enabled.", //GW_MAC_FILTER_WPS_DISABLED
	"" //MAX
);
var _Advanced_01=0;
var _Advanced_03=1;
...
var _wz_disWPS=4687;
var limit_pass_msg=4688;
var _wz_mydlink_email_1=4689;
var _gz_wps_enable=4690;
var _gz_wps_deny=4691;
var bwl_ht204080=4692;
var _supp_close=4693;
var bwl_Mode_ac=4694;
var bwl_Mode_acn=4695;
var bwl_Mode_acna=4696;
var _adv6_metric=4697;
var _wifi_ssid=4698;
var IPV6_TEXT171=4699;
var IPV6_TEXT172=4700;
var _testing_=4701;
var drws_err_5001=4702;
var drws_err_5002=4703;
var drws_err_5003=4704;
var drws_err_5004=4705;
var drws_err_5005=4706;
var drws_err_5006=4707;
var drws_err_5007=4708;
var drws_err_5008=4709;
var drws_err_5009=4710;
var drws_err_5010=4711;
var drws_err_5011=4712;
var drws_err_5101=4713;
var drws_err_5102=4714;
var drws_err_5103=4715;
var drws_err_5104=4716;
var _dynamic=4717;
var _static=4718;
var _wps_use_pin=4719;
var _v6firewall_iface=4720;
var wwa_intro_s3a=4721;
var wwa_intro_s5=4722;
var wwa_intro_s1a=4723;
var up_tz_76=4724;
var up_tz_77=4725;
var up_tz_78=4726;
var up_tz_79=4727;
...
var up_tz_91=4739;
var up_tz_92=4740;
var sh_port_tx_24=4741;
var sto_user_path=4742;
var ar_alert_3a=4743;
var IPV6_TEXT173=4744;
var wwa_wanmode_rupppoe=4745;
var wwa_wanmode_rupptp=4746;
var wwa_wanmode_rul2tp=4747;
var wwa_title_set_rupppoe=4748;
var wwa_title_set_rupptp=4749;
var wwa_title_set_rul2tp=4750;
var _LAN_CHK_REBOOT_MSG=4751;
var TEXT079=4752;
var sto_link_3=4753;
var DFS_TEXT001=4754;
var DFS_TEXT002=4755;
var samba_title_up=4756;
var samba_title_low=4757;
var samba_admin=4758;
var samba_user=4759;
var invalid_cd=4760;
var sto_http_7=4761;
var sto_http_link=4762;
var sto_https_link=4763;
var ddns_processing=4764;
var sl_alert_4=4765;
var ssid_ascii_range=4765;
var ip_gateway_check=4766;
var GW_MAC_FILTER_WPS_DISABLED=4767;