	...
	function DataShow(){
		...
		for (var i=0; i<array_enable.length;i++)
		{
			if(array_enable[i]==1)
			{
				...
				document.write("<td class=\"break_word\">"+ filter_ipv6_addr(array_destipv6ip[i]) +"/"+ array_destipv6prefix[i] +"</td>");
				document.write("<td class=\"break_word\">"+ filter_ipv6_addr(array_gatewayip[i]) +"</td>");
		...
		{
			var iface = "";
			if (array_dynamic_iface[i] === "2") {
				iface = "WAN";
			} else if(array_dynamic_iface[i] === "1"){
				iface = "LAN";
			...
			document.write("<tr bgcolor=\"#F0F0F0\">");
			document.write("<td class=\"break_word\">"+ filter_ipv6_addr(array_dynamic_ip6[i]) +"</td>");
			document.write("<td class=\"break_word\">"+ filter_ipv6_addr(array_dynamic_gw6[i]) +"</td>");
