...
<script language="JavaScript">
	...
	param.arg +="&oid_3=IGD_WANDevice_i_WANConnectionDevice_i_PPPoE_i_&inst_3=11110";
	...
	var adv_dns_en = config_val('pppoeCfg_AdvancedDNSEnable_');
	...
	var ipDNSServ = config_val("pppoeCfg_DNSServers_").split(",");
...
*/
function onPageLoad(){
	//set_checked(config_val("igd_DeviceMode_"), get_by_name("dev_mode"))

	get_by_id("asp_temp_52").value = config_val("wanConnDev_CurrentConnObjType_"); 

	set_checked(config_val("pppoeCfg_IPAddressType_"), get_by_name("wan_pppoe_dynamic_00"));
	set_checked(config_val("pppoeCfg_ConnectionTrigger_"), get_by_name("wan_pppoe_connect_mode_00"));
	...
	get_by_id("wan_pppoe_ipaddr_00").value = config_val("pppoeCfg_ExternalIPAddress_");
	get_by_id("wan_pppoe_username_00").value = config_val("pppoeCfg_Username_");
	get_by_id("wan_pppoe_service_00").value = unescape(config_val("pppoeCfg_ServiceName_"));
	get_by_id("wan_pppoe_max_idle_time_00").value = config_val("pppoeCfg_IdleDisconnectTime_");
	...
	get_by_id("wan_pppoe_mtu").value = config_val("pppoeCfg_MaxMTUSize_");

	//set_checked(config_val("pppoeCfg_NetSniperSupport_"), get_by_id("netSniper"));
	//get_by_id("dialModeSel").selectedIndex = config_val("pppoeCfg_SpecialDialMode_");
	...
	//set_checked(config_val("pppoeCfg_PPPoEPlusDialEnable_"), get_by_id("pppoe_plus_dial"));
...
function check_connectmode(){
	...
	{
		var srv_name = $('#wan_pppoe_service_00').val();
		...
		if (!check_service_name(srv_name))
		{
			alert(get_words('_srvname') + " " + get_words('mydlink_pop_04'));
			return false;
		}

		connect_mode = get_checked_value(get_by_name("wan_pppoe_connect_mode_00"));
	...
	function copyDataToDataModelFormat()
	{
		...
		get_by_id("pppoeCfg_ServiceName_1.1.1.1.0").value = urlencode(get_by_id("wan_pppoe_service_00").value);
		get_by_id("pppoeCfg_Username_1.1.1.1.0").value = get_by_id("wan_pppoe_username_00").value;
		if(get_by_id("poe_pass_s").value  == "WDB8WvbXdH")
			get_by_id("pppoeCfg_Password_1.1.1.1.0").value = config_val("pppoeCfg_Password_");
		else
			get_by_id("pppoeCfg_Password_1.1.1.1.0").value = get_by_id("poe_pass_s").value;
			
		get_by_id("pppoeCfg_DNSServers_1.1.1.1.0").value = get_by_id("wan_primary_dns").value;
		if(get_by_id("wan_secondary_dns").value != "")
			get_by_id("pppoeCfg_DNSServers_1.1.1.1.0").value += ","+get_by_id("wan_secondary_dns").value;
			
		get_by_id("pppoeCfg_ConnectionTrigger_1.1.1.1.0").value = connect_mode;
		get_by_id("pppoeCfg_IdleDisconnectTime_1.1.1.1.0").value = get_by_id("wan_pppoe_max_idle_time_00").value;
		get_by_id("pppoeCfg_MaxMTUSize_1.1.1.1.0").value = get_by_id("wan_pppoe_mtu").value;
...
<body topmargin="1" leftmargin="0" rightmargin="0" bgcolor="#757575">
    ...
    <table id="topnav_container" border="1" cellpadding="2" cellspacing="0" width="838" height="100%" align="center" bgcolor="#FFFFFF" bordercolordark="#FFFFFF">        <tr>
			...
			<form id="form2" name="form2" method="post" action="get_set.ccp">
				...
				<input type="hidden" name="wanConnDev_CurrentConnObjType_1.1.1.0.0" id="wanConnDev_CurrentConnObjType_1.1.1.0.0" value="2">
				...
				<input type="hidden" name="pppoeCfg_IPAddressType_1.1.1.1.0" id="pppoeCfg_IPAddressType_1.1.1.1.0" value="">
				<input type="hidden" name="pppoeCfg_ExternalIPAddress_1.1.1.1.0" id="pppoeCfg_ExternalIPAddress_1.1.1.1.0" value="">
				<input type="hidden" name="pppoeCfg_ServiceName_1.1.1.1.0" id="pppoeCfg_ServiceName_1.1.1.1.0" value="">
				<input type="hidden" name="pppoeCfg_Username_1.1.1.1.0" id="pppoeCfg_Username_1.1.1.1.0" value="">
				<input type="hidden" name="pppoeCfg_Password_1.1.1.1.0" id="pppoeCfg_Password_1.1.1.1.0" value="">
				<input type="hidden" name="pppoeCfg_AdvancedDNSEnable_1.1.1.1.0" id="pppoeCfg_AdvancedDNSEnable_1.1.1.1.0" value="0">
				<input type="hidden" name="pppoeCfg_DNSEnabled_1.1.1.1.0" id="pppoeCfg_DNSEnabled_1.1.1.1.0" value="1">
				<input type="hidden" name="pppoeCfg_DNSServers_1.1.1.1.0" id="pppoeCfg_DNSServers_1.1.1.1.0" value="">
				<input type="hidden" name="pppoeCfg_ConnectionTrigger_1.1.1.1.0" id="pppoeCfg_ConnectionTrigger_1.1.1.1.0" value="">
				<input type="hidden" name="pppoeCfg_IdleDisconnectTime_1.1.1.1.0" id="pppoeCfg_IdleDisconnectTime_1.1.1.1.0" value="">
				<input type="hidden" name="pppoeCfg_MaxMTUSize_1.1.1.1.0" id="pppoeCfg_MaxMTUSize_1.1.1.1.0" value="">
				<input type="hidden" name="pppoeCfg_NetSniperSupport_1.1.1.1.0" id="pppoeCfg_NetSniperSupport_1.1.1.1.0" value="">
				<input type="hidden" name="pppoeCfg_SpecialDialMode_1.1.1.1.0" id="pppoeCfg_SpecialDialMode_1.1.1.1.0" value="">
				<input type="hidden" name="pppoeCfg_PPPoEPlusDialEnable_1.1.1.1.0" id="pppoeCfg_PPPoEPlusDialEnable_1.1.1.1.0" value="">
            ...
            <input name="button" id="button" type="button" class=button_submit value="" onClick="return send_pppoe_request()">
                ...
                <table cellSpacing=1 cellPadding=1 width=525 border=0>
                    <tr>
                      ...
                      <td width="331">&nbsp; <select name="wan_proto" id="wan_proto" onChange="change_wan()">
                        ...
                        <option value="2" selected><script>show_words(bwn_Mode_PPPoE)</script></option>
              ...
              <div class=box id=show_poe >
                ...
                <td align=right class="duple">
                  ...
                  :</td>
                      ...
                      <td>&nbsp;
                          <input type=radio name="wan_pppoe_connect_mode_00" value="0" onClick="check_connectmode()">

                  <script>show_words(bwn_RM_0)</script>

                          <input type=radio name="wan_pppoe_connect_mode_00" value="2" onClick="check_connectmode()">

                  <script>show_words(bwn_RM_1)</script>

                          <input type=radio name="wan_pppoe_connect_mode_00" value="1" onClick="check_connectmode()">
                ...
                <td align=right class="duple">
                  ...
                  :</td>
                      ...
                      <td>&nbsp;
                        <input type=text id="wan_pppoe_max_idle_time_00" name="wan_pppoe_max_idle_time_00" size="10" maxlength="5" value="">
                ...
                <td align=right class="duple">
                  ...
                  :</td>
                      ...
                      <td>&nbsp;
                        <input type=text id="wan_pppoe_mtu" name="wan_pppoe_mtu" size="10" maxlength="5" value="">
