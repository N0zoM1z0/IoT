...
<script language="JavaScript">
	...
	param.arg +="&oid_2=IGD_WANDevice_i_WANConnectionDevice_i_L2TP_i_&inst_2=11110";
	param.arg +="&oid_3=IGD_WANDevice_i_WANConnectionDevice_i_L2TP_i_ConnectionCfg_i_&inst_3=11111";
	...
	var ipDNSServ = config_val("l2tpCfg_DNSServers_").split(",");
	var adv_dns_en = config_val('l2tpCfg_AdvancedDNSEnable_');
...
*/
    function onPageLoad()
    {
		set_checked(config_val("l2tpCfg_IPAddressType_"),get_by_name("wan_l2tp_dynamic"));
		set_checked(config_val("l2tpConn_ConnectionTrigger_"),get_by_name("wan_l2tp_connect_mode"));
		//set_checked(adv_dns_en, get_by_id('opendns_enable_sel'));
		//if (adv_dns_en == '1') {
		//	opendns_enable_selector(true);
		//}
		
		get_by_id("wan_l2tp_ipaddr").value = config_val("l2tpCfg_ExternalIPAddress_");
		get_by_id("wan_l2tp_netmask").value = config_val("l2tpCfg_SubnetMask_");
		get_by_id("wan_l2tp_gateway").value = config_val("l2tpCfg_DefaultGateway_");
		...
		if(ipDNSServ[1])
			...
			get_by_id("wan_secondary_dns").value = "0.0.0.0";
		get_by_id("wan_l2tp_server_ip").value = config_val("l2tpConn_ServerIP_");
		get_by_id("wan_l2tp_username").value = config_val("l2tpConn_Username_");
		//get_by_id("wan_l2tp_password").value = config_val("");
		get_by_id("wan_l2tp_max_idle_time").value = config_val("l2tpConn_IdleDisconnectTime_");
		get_by_id("wan_l2tp_mtu").value = config_val("l2tpConn_MaxMTUSize_");
		...
		//disable_static_address(get_by_name("wan_l2tp_dynamic"), get_by_id("wan_l2tp_ipaddr"), get_by_id("wan_l2tp_netmask"), get_by_id("wan_l2tp_gateway"), get_by_id("wan_primary_dns"));
	...
	function send_request(){
		...
		connect_mode = get_checked_value(get_by_name("wan_l2tp_connect_mode"));
		...
		if((get_by_id("wan_l2tp_server_ip").value == "") ||
			(get_by_id("wan_l2tp_server_ip").value == "0.0.0.0") ||
			(get_by_id("wan_l2tp_server_ip").value == "255.255.255.255")){
		...
		**/
		if(ip_pattern($('#wan_l2tp_server_ip').val()))
		{
	...
	{
		get_by_id("l2tpCfg_IPAddressType_1.1.1.1.0").value = get_checked_value(get_by_name("wan_l2tp_dynamic"));
		get_by_id("l2tpCfg_ExternalIPAddress_1.1.1.1.0").value = get_by_id("wan_l2tp_ipaddr").value;
		get_by_id("l2tpCfg_SubnetMask_1.1.1.1.0").value = get_by_id("wan_l2tp_netmask").value;
		get_by_id("l2tpCfg_DefaultGateway_1.1.1.1.0").value = get_by_id("wan_l2tp_gateway").value;
		//get_by_id("l2tpCfg_DNSEnabled_1.1.1.1.0").value = get_by_id("");
		get_by_id("l2tpCfg_DNSServers_1.1.1.1.0").value = get_by_id("wan_primary_dns").value;
		if(get_by_id("wan_secondary_dns").value != "")
			get_by_id("l2tpCfg_DNSServers_1.1.1.1.0").value += ","+get_by_id("wan_secondary_dns").value;
		get_by_id("l2tpConn_ServerIP_1.1.1.1.1").value = get_by_id("wan_l2tp_server_ip").value;
		get_by_id("l2tpConn_Username_1.1.1.1.1").value = get_by_id("wan_l2tp_username").value;
		//if(get_by_id("wan_l2tp_password").value == "WDB8WvbXdHtZyM8Ms2RENgHlacJghQyG")
			//get_by_id("l2tpConn_Password_1.1.1.1.1").value = config_val("l2tpConn_Password_");
		//else
			get_by_id("l2tpConn_Password_1.1.1.1.1").value = get_by_id("l2tppwd1").value;
		get_by_id("l2tpConn_ConnectionTrigger_1.1.1.1.1").value = connect_mode;
		get_by_id("l2tpConn_IdleDisconnectTime_1.1.1.1.1").value = get_by_id("wan_l2tp_max_idle_time").value;
		get_by_id("l2tpConn_MaxMTUSize_1.1.1.1.1").value = get_by_id("wan_l2tp_mtu").value;

		//get_by_id("l2tpCfg_AdvancedDNSEnable_1.1.1.1.0").value = get_checked_value(get_by_id("opendns_enable_sel"));
...
<body topmargin="1" leftmargin="0" rightmargin="0" bgcolor="#757575">
    ...
    <table id="topnav_container" border="1" cellpadding="2" cellspacing="0" width="838" height="100%" align="center" bgcolor="#FFFFFF" bordercolordark="#FFFFFF">        <tr>
			...
			<form id="form2" name="form2" method="post" action="get_set.ccp">
				...
				<input type="hidden" name="nextPage" value="wan_l2tp.asp">
				<input type="hidden" name="wanConnDev_CurrentConnObjType_1.1.1.0.0" id="wanConnDev_CurrentConnObjType_1.1.1.0.0" value="4">
				...
				<input type="hidden" name="l2tpCfg_IPAddressType_1.1.1.1.0" id="l2tpCfg_IPAddressType_1.1.1.1.0" value="">
				<input type="hidden" name="l2tpCfg_ExternalIPAddress_1.1.1.1.0" id="l2tpCfg_ExternalIPAddress_1.1.1.1.0" value="">
				<input type="hidden" name="l2tpCfg_SubnetMask_1.1.1.1.0" id="l2tpCfg_SubnetMask_1.1.1.1.0" value="">
				<input type="hidden" name="l2tpCfg_DefaultGateway_1.1.1.1.0" id="l2tpCfg_DefaultGateway_1.1.1.1.0" value="">
				<input type="hidden" name="l2tpCfg_AdvancedDNSEnable_1.1.1.1.0" id="l2tpCfg_AdvancedDNSEnable_1.1.1.1.0" value="0">
				<input type="hidden" name="l2tpCfg_DNSEnabled_1.1.1.1.0" id="l2tpCfg_DNSEnabled_1.1.1.1.0" value="1">
				<input type="hidden" name="l2tpCfg_DNSServers_1.1.1.1.0" id="l2tpCfg_DNSServers_1.1.1.1.0" value="">
				<input type="hidden" name="l2tpConn_ServerIP_1.1.1.1.1" id="l2tpConn_ServerIP_1.1.1.1.1" value="">
				<input type="hidden" name="l2tpConn_Username_1.1.1.1.1" id="l2tpConn_Username_1.1.1.1.1" value="">
				<input type="hidden" name="l2tpConn_Password_1.1.1.1.1" id="l2tpConn_Password_1.1.1.1.1" value="">
				<input type="hidden" name="l2tpConn_ConnectionTrigger_1.1.1.1.1" id="l2tpConn_ConnectionTrigger_1.1.1.1.1" value="">
				<input type="hidden" name="l2tpConn_IdleDisconnectTime_1.1.1.1.1" id="l2tpConn_IdleDisconnectTime_1.1.1.1.1" value="">
				<input type="hidden" name="l2tpConn_MaxMTUSize_1.1.1.1.1" id="l2tpConn_MaxMTUSize_1.1.1.1.1" value="">
			</form>
                ...
                <table cellSpacing=1 cellPadding=1 width=525 border=0>
                    <tr>
                      ...
                      <td width="331">&nbsp; <select name="wan_proto" id="wan_proto" onChange="change_wan()">
                        ...
                        <option value="4" selected><script>show_words(bwn_Mode_L2TP)</script></option>
              ...
              <div class=box id=show_l2tp>
                ...
                <td width="185" align=right class="duple">
                  ...
                  <script>show_words(bwn_AM)</script>
                      ...
                      <td width="331">&nbsp;
                          <input type=radio value="0" name="wan_l2tp_dynamic" onClick=disable_l2tp_ip() checked>

                  <script>show_words(carriertype_ct_0)</script>

                          <input type=radio value="1" name="wan_l2tp_dynamic" onClick=disable_l2tp_ip()>
                ...
                <td align=right class="duple">
                  ...
                  :</td>
                      ...
                      <td>&nbsp;
                        <input type=text id="wan_l2tp_ipaddr" name="wan_l2tp_ipaddr" size="20" maxlength="15" value=''>
                      </td>
                    </tr>
                    <tr>
                ...
                <td align=right class="duple">
                  ...
                  :</td>
                      ...
                      <td>&nbsp;
                        <input type=text id="wan_l2tp_netmask" name="wan_l2tp_netmask" size="20" maxlength="15" value=''>
                      </td>
                    </tr>
                    <tr>
                ...
                <td align=right class="duple">
                  ...
                  :</td>
                      ...
                      <td>&nbsp;
                        <input name="wan_l2tp_gateway" type=text id="wan_l2tp_gateway" size="20" maxlength="15" value=''>
                      </td>
                    </tr>
                    <tr>
                ...
                <td align=right class="duple">
                  ...
                  :</td>
                      ...
                      <td>&nbsp;
                        <input type=text id="wan_l2tp_server_ip" name="wan_l2tp_server_ip" size="20" maxlength="64" value=''>
                      </td>
                    </tr>
                    <tr>
                ...
                <td align=right class="duple">
                  ...
                  :</td>
                      ...
                      <td>&nbsp;
                        <input type=text id="wan_l2tp_username" name="wan_l2tp_username" size="20" maxlength="63" value=''>
                      </td>
                    </tr>
                    <tr>
                ...
                <td align=right class="duple">
                  ...
                  :</td>
                      ...
                      <td>&nbsp;
                        <input type=password id="l2tppwd1" name="l2tppwd1" size="20" maxlength="63" onfocus="select();" value="WDB8WvbXdHtZyM8Ms2RENgHlacJghQyGWDB8WvbXdHtZyM8Ms2RENgHlacJghQyG" >
                      </td>
                    </tr>
                    <tr>
                ...
                <td align=right class="duple">
                  ...
                  :</td>
                      ...
                      <td>&nbsp;
                        <input type=radio name="wan_l2tp_connect_mode" value="0" onClick="check_connectmode()">

                  <script>show_words(bwn_RM_0)</script>

                        <input type=radio name="wan_l2tp_connect_mode" value="2" onClick="check_connectmode()">

                  <script>show_words(bwn_RM_1)</script>

                        <input type=radio name="wan_l2tp_connect_mode" value="1" onClick="check_connectmode()">
                ...
                <td align=right class="duple">
                  ...
                  :</td>
                      ...
                      <td>&nbsp;
                          <input type=text id="wan_l2tp_max_idle_time" name="wan_l2tp_max_idle_time" maxlength="5" size="10" value=''>
                ...
                <td align=right class="duple">
                  ...
                  :</td>
                      ...
                      <td>&nbsp;
                        <input type=text id="wan_l2tp_mtu" name="wan_l2tp_mtu" size="10" maxlength="5" value=''>
