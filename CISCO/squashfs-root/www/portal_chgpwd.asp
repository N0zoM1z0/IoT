...
var old_pwd = "<% get_user_data("admin_pwd"); %>";
...
<TABLE class=CONTENT_TABLE>
  ...
  <TR><TD colspan=2>
		...
		document.write("<li>"+__TC(mang.minpwdlen)+"&nbsp;&nbsp;<% nvram_get("pwd_minlen"); %></li><li>"+__TC(mang.mincharlen)+"&nbsp;&nbsp;<% nvram_get("pwd_minclass"); %></li>");
		</script></TD></TR>
		<TR><script>draw_td(O_GUI,SUBTITLE_MSG,"colspan=2;");
		Capture(mang.chgpwdenterpwd);
		</script></TD></TR>
		
		<TR><script>draw_td(O_GUI,SUBTITLE,__TC(mang.oldpwd));</script>
		<input size=20 maxlength=64 name=admin_old_pwd id=admin_old_pwd type=password>
		<SPAN id=msg_admin_old_pwd></SPAN>
                </TD></TR>

		<TR><script>draw_td(O_GUI,SUBTITLE,__TC(mang.newpwd));</script>
		...
		<TR><script>draw_td(O_GUI,SUBTITLE,__TC(chpass.confirmpwd));</script>
		<input size=20 maxlength=64 name=admin_cmp_pwd id=admin_cmp_pwd type=password>
		<SPAN id=msg_admin_cmp_pwd></SPAN>
                </TD></TR>

		<TR><script>draw_td(O_GUI,SUBTITLE,__TC(chpass.strengthpwd));</script>
