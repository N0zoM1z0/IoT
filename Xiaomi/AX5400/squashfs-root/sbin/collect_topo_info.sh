...
\"backhaul_ap_bssid_5g\":\"$backhaul_ap_bssid_5g\",\"uplink_mac\":\"$uplink_mac\",\"snr\":$snr,\"router_name\":\"$(base64_enc "$router_name")\",\"supp_new_topo\":$supp_new_topo,\"eth_link_rate\":\"$eth_link_rate\"}"
