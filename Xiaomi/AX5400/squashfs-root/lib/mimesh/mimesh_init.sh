...
__init_wifi_cap()
{
	...
	uci set wireless.$iface_5g_index.mesh_ver="$mesh_version"
...
set wireless.@wifi-iface[$ii].channel_block_list='52,56,60,64,100,104,108,112,116,120,124,128,132,136,140,149,153,157,161,165'
...
EOF
	...
	uci -q set wireless.$iface_5g.channel_block_list='52,56,60,64,100,104,108,112,116,120,124,128,132,136,140,149,153,157,161,165'
...
__init_cap()
{
	...
	if [ "$support_mesh_ver4" != "1" -o "$meshsuite" != "1" ]; then
