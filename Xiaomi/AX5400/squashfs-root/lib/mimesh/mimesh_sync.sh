...
__get_system()
{
	...
	[ -z "$led_blue" ] && led_blue=1
        ...
        xled="`uci -q get miled.settings.status`"
        [ -z "$xled" ] && xled=0
...
\"timezone\":\"$timezone\",\"ota_auto\":\"$ota_auto\",\"ota_time\":\"$ota_time\",\"led_blue\":\"$led_blue\",\"ethled\":\"$ethled\",\"xled\":\"$xled\",\
\"miscan_enable\":\"$miscan_enable\",\"support160\":\"$support160\",\
