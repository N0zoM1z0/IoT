...
#get 2g nss
nss_2g=`iwpriv $ap_ifname_2g get TxStream | awk -F '[:]' '{print $NF}' | sed 's/[ \t]*$//g'`

#get 2g channel
channel_2g="`mtknetlink_cli $ap_ifname_2g getChannel|cut -d ':' -f 3`"

#get 2g width and phy mode
mode="`iwpriv $ap_ifname_2g get phymode | awk -F '[:]' '{print $NF}'`"
...
#get 5g nss
nss_5g=`iwpriv $ap_ifname_5g get TxStream | awk -F '[:]' '{print $NF}' | sed 's/[ \t]*$//g'`

#get 5g channel
channel_5g="`mtknetlink_cli $ap_ifname_5g getChannel|cut -d ':' -f 3`"

#get 5g width and phy mode
mode="`iwpriv $ap_ifname_5g get phymode | awk -F '[:]' '{print $NF}'`"
...
\"backhaul_ap_bssid_5g\":\"$backhaul_ap_bssid_5g\",\"uplink_mac\":\"$uplink_mac\",\"snr\":$snr,\"router_name\":\"$router_name\",\"supp_new_topo\":$supp_new_topo,\"eth_link_rate\":\"$eth_link_rate\"}"
