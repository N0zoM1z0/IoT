...
function Load()
{
	...
	this.detectWidthImg = function(callBack)
	{
		...
		img.src = this.domainUrl + imgDetectPathStr + "?requence=" + Math.random();
	}
	...
	this.detect = function (detectHandler)
	{
		...
		{
			this.request((this.domainUrl + detectPathStr + "?requence=" + Math.random()), undefined, "get", this.asyn, detectHandler);
		}
	};
