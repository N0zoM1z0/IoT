function SLP()
{
	...
	this.g11AXSupport = false; // 支持11ax
	...
	this.protocol = {
		...
		setData: function(options){
			...
			var wan = this.setOptions.data[uciProto.secName.wan];
	...
	this.latestWanStatus = function(callback, isImmediately){
		var self = this;
		var timeStamp = new Date().getTime();

		if ((isImmediately == undefined || isImmediately == false) && (null != this.timeStamp) &&
			(timeStamp - this.timeStamp < this.expire))
		{
