var uciAppInfo = {
    ...
    secName: {
        ...
        ipv6SwitchStatus2: 'ipv6_switch_status_2'
    },
    optName: {
        ifName: 'ifname',
        proto: 'proto',
    ...
    optValue: {
        proto: {
            ...
            pppoe2: 'pppoe_2',
            bridge: 'bridge',
            wiredRelay: 'wired_relay',
            wdsRelay: 'wds_relay',
            dynIpv6: 'dhcpcv6',
            dynIpv62: 'dhcpcv6_2',
            staticIpv6: 'staticv6',
            staticIpv62: 'staticv6_2',
            pppoev6: 'pppoev6',
            pppoev62: 'pppoev6_2',
            bridgev6: 'bridgev6',
            dynsIpv6: 'dhcpsv6',
        ...
        wanSpeed: 'auto 10F 10H 100F 100H 1000F'.split(' '),
        dnsMode: {
            dynamic: 'dynamic',
            manual: 'manual'
        },
    ...
    action: { switchIpv6: 'switch_ipv6' }
}, uciMs = {
    fileName: 'media_server',
    secType: { share: 'ms_dir' },
    secName: {
        user: 'user',
        sys: 'sys'
    },
    ...
    dynData: { dhcpClient: 'dhcp_clients' }
}, uciArp = {
    fileName: 'ip_mac_bind',
    secType: { arp: 'user_bind' },
    optName: {
        ipAddr: 'ip',
        mac: 'mac',
        status: 'status',
    ...
    fileName: 'upnpd',
    secType: { upnpd: 'upnpd' },
    secName: { upnpCfg: 'config' },
    optName: {
        uatPmp: 'enable_natpmp',
        upnp: 'enable_upnp'
    },
    dynData: { upnpLease: 'upnp_lease' }
}, uciDdns = {
    fileName: 'ddns',
    secType: { ddns: 'ddns' },
    secName: { phDdns: 'phddns' },
    optName: {
        autologin: 'auto_login',
        username: 'username',
        password: 'password'
    },
    dynData: { ddnsStatus: 'ddns_status' }
}, uciWireless = {
    fileName: 'wireless',
    secType: {
    ...
    secType: { cloudReply: 'cloud_reply' },
    secName: {
        bind: 'bind',
        info: 'info',
        register: 'register',
    ...
    optName: {
        ...
        hnat: 'hnat',
        ipv6: 'ipv6',
        supportIpv6HostCtrl: 'support_ipv6_host_ctrl',
        supportIPv6Firewall: 'ipv6_firewall_switch',
        ...
        loadBalanceMode: 'mwan_load_balance_mode',
    ...
    actionName: {},
    secType: { timeSwitch: 'time_switch' },
    secName: {
        general: 'general',
    ...
    secType: { rebootTimerRule: 'reboot_timer_rule' },
    optName: {
        enable: 'enable',
        name: 'name',
        mon: 'mon',
    ...
    actionName: {},
    secType: { ledTimeSwitch: 'led_time_switch' },
    secName: {
        general: 'general',
        clockSuccess: 'clock_success'
    },
    ...
    dynData: { wifi_switch: 'wifi_switch' },
    actionName: {
        wpsLink: 'wps_link',
    ...
    secName: { macFilterConfig: 'mac_filter_config' },
    optName: {
        mode: 'mode',
        enable: 'enable',
        policy: 'policy',
    ...
    secType: { iptvEntry: 'iptv_entry' },
    optName: {
        iptvEntry1: 'iptv_entry_1',
        iptvEntry2: 'iptv_entry_2',
        wanIndex: 'wan_index',
        workMode: 'work_mode',
        linkMode: 'link_mode',
        vlanId: 'vlan_id'
