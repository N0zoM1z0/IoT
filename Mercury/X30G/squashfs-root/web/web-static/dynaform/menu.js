...
var menu = {
	...
	portCustom_menu:{
		value: menuStr.portCustom,
		className:"icon-port_customize",
		url: "PortOverview.htm",
		hasSub: true,
		subMenu:
		[
			{
				value: menuStr.portOverview,
				url: "PortOverview.htm"
			},
			{
				value: menuStr.dualWanPort,
				url: "DualWanPort.htm"
			},
			{
				value: menuStr.iptvPort,
				url: "IPTVPort.htm"
			},
			{
				value: menuStr.gamePort,
				url: "GamePort.htm"
			},
			{
				value: menuStr.portLag,
				url: "PortLag.htm"
			},
			{
				value: menuStr.sfpPortRate,
				url: "SfpPortRate.htm"
			}
		]
	},
...
function menuInit()
{
	...
	{
		delete menu.portCustom_menu;
	}
	else
	{
		if(!slp.gMulWanSupport)
		{
			removeSubMenu(menu.portCustom_menu.subMenu, "DualWanPort.htm");
		}
		else
		{
			removeSubMenu(menu.highUser_menu.subMenu, "RouteTable.htm");
		}
		if(!slp.gIptvSupport)
		{
			removeSubMenu(menu.portCustom_menu.subMenu, "IPTVPort.htm");
		}
		if(!slp.gGameSupport)
		{
			removeSubMenu(menu.portCustom_menu.subMenu, "GamePort.htm");
		}
		if(!slp.gLagSupport)
		{
			removeSubMenu(menu.portCustom_menu.subMenu, "PortLag.htm");
		}
		if(!slp.gSfpRateSupport)
		{
			removeSubMenu(menu.portCustom_menu.subMenu, "SfpPortRate.htm");
		}
	}
	...
	{
		removeSubMenu(menu.wifiSet_menu.subMenu, "WlanWDSCfg.htm");
	}
