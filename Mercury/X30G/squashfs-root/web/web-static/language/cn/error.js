...
var EFRTIMEPERIODBLANK = -50418;		/* 禁止上网时间限制时间段描述为空 */
var EFRTIMEPERIODTOOLONG = -50419;		/* 禁止上网时间限制时间段描述太长 */
var EFRINVTPBEGINTIME = -50420;			/* 禁止上网时间限制开始时间非法 */
var EFRINVTPENDTIME = -50421;			/* 禁止上网时间限制结束时间非法 */
var EFRINVBEGINENDTIME = -50422;		/* 禁止上网时间限制开始时间不比结束时间早 */
var EFRTIMEPERIODREPEATBLANK = -50423;	/* 禁止上网时间限制重复周期为空 */
var EFRTIMEPERIODREPEATINV = -50424;	/* 禁止上网时间限制重复周期非法 */
var EFRINVTIMEPERIOD = -50425;			/* 禁止上网时间限制非法 */
...
var ECHPWDDIF = -50933;              			/* 原密码和确认密码不一致 */
var EUSRERROR = -50934;             	/* 登录用户名长度不合法 */
var EUSRBLANK = -50935;					/* 登录用户名含有非法字符 */
var EINLGUSRVALOLDSAME = -50940;		/* 原用户名或者密码错误 */
...
var EINDEVICENOTBIND = -51225;				/* 未绑定CLOUD云帐号，无法安装应用*/
...
var EINVACCOUNTLOCKED = -20661;							/* 云服务器锁定该CLOUD ID 2小时 */		/****/
...
var ETSTIMECONFLICT = -51809;           /* 无线定时开关时间重合 */

/* --------------------------------- 模块reboot_timer错误 ----------------------------- */
var EINVRTTIMEDESCBLANK = -52001;		/* 自动清理规则描述为空 */
var EINVRTTIMEDESCTOOLONG = -52002;		/* 自动清理规则描述过长 */
var EINVTLRTTIME = -52003;				/* 自动清理规则开启时间非法 */
var EINVTLRTWEEKBLANK = -52004;			/* 自动清理规则重复周期为空 */
var EINVTLRTWEEK = -52005;				/* 自动清理规则重复周期非法 */
var EINVSAMERTRULE = -52007;			/* 出现相同的自动清理规则 */

/* ---------------------------------- LED定时开关错误 -------------------------------- */
//var ELEDTIMEDESCBLANK = -52001;		/* LED定时开关规则描述为空 */
//var ELEDTIMEDESCTOOLONG = -52002;	/* LED定时开关规则描述过长 */
//var ELEDENDEQUALSTART = -52003;		/* LED定时开关开启时间与结束时间相同 */
//var ELEDINVTIME = -52004;			/* LED定时开关规则时间值非法 */
//var ELEDINVWEEK = -52005;			/* LED定时开关规则重复周期非法 */
//var ELEDSAMERULE = -52006			/* 出现相同的LED定时开关规则 */
