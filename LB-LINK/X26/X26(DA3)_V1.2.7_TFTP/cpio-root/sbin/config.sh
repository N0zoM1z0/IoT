...
CONFIG_BLINK_UIMAGE_ENCRYPT=y
CONFIG_BLINK_CONFIG_BAK=y
CONFIG_BLINK_CONFIG_PRIVATE=y
...
CONFIG_SECOND_IF_MT7663E=y
CONFIG_RT_FIRST_CARD=7628
CONFIG_RT_SECOND_CARD=7663e
...
CONFIG_MT7628_IGMP_SNOOP_SUPPORT=y
CONFIG_MT7628_NEW_BW2040_COEXIST_SUPPORT=y
CONFIG_MT7628_RATE_ADAPTION=y
CONFIG_MT7628_NEW_RATE_ADAPT_SUPPORT=y
CONFIG_MT7628_SMART_CARRIER_SENSE_SUPPORT=y
CONFIG_MT7628_LED_CONTROL_SUPPORT=y
CONFIG_MT7628_ATE_SUPPORT=y
CONFIG_MT7628_UAPSD=y
CONFIG_MT7628_MAC=y

CONFIG_MT7628_WIFI_MODE_AP=y
CONFIG_MT7628_AP_SUPPORT=y
...
CONFIG_MT7663BE_FIRST_IF_EEPROM_FLASH=y
CONFIG_MT7663BE_SECOND_IF_EEPROM_FLASH=y
...
CONFIG_THIRD_IF_IPAILNA=y

CONFIG_MT7663BE_WIFI_MODE_AP=y
...
CONFIG_LIB_LIBCJSON_FORCE=y
CONFIG_LIB_LIBPUBLIC_FORCE=y
CONFIG_LIB_LIBBLINK_FORCE=y
CONFIG_LIB_LIBSHARE_FORCE=y


CONFIG_BLINK_APP=y
CONFIG_BLINK_CMD_CONVERT=y
CONFIG_BLINK_WAN_CHECK=y
CONFIG_BLINK_USR_FLOW=y
CONFIG_BLINK_SPEED_TEST=y
CONFIG_BLINK_UPGRADE=y
CONFIG_BLINK_DAEMON=y
CONFIG_BLINK_CLOUD=y
CONFIG_BLINK_FILTER=y
CONFIG_BLINK_SMART_ROUTING=y
CONFIG_BLINK_ROUTER_IP=y
CONFIG_BLINK_REPEATER_IP=y
CONFIG_BLINK_GUESTNETWORK_FILTER=y
CONFIG_BLINK_DUAL_BAND_ROUTER=y
CONFIG_BLINK_GOAHEAD_BLINK=y
CONFIG_BLINK_UIMAGE_ENCRYPT=y
BLINK_CONFIG_BAK=y
BLINK_CONFIG_PRIVATE=y
CONFIG_BLINK_LED_SWITCH_CONTROL=y
CONFIG_BLINK_WGET=y
CONFIG_BLINK_SELF_BUILT_PARTITION=y
CONFIG_IWPRIV_SET_WPS=y
CONFIG_BLINK_SMART_QOS=y
CONFIG_WIFI_LIMIT_SETTING=y
CONFIG_BLINK_ONLINE_NOTICE=y
CONFIG_BLINK_URL_FILTER=y
CONFIG_WEBREMOTEMANAGE=y
CONFIG_BLINK_PROJECT=y
CONFIG_LIB_LIBNVRAM_FORCE=y
